...
instance Arbitrary V1AppArmorProfile where
  arbitrary = sized genV1AppArmorProfile

genV1AppArmorProfile :: Int -> Gen V1AppArmorProfile
genV1AppArmorProfile n =
  V1AppArmorProfile
    <$> arbitraryReducedMaybe n -- v1AppArmorProfileLocalhostProfile :: Maybe Text
    <*> arbitrary -- v1AppArmorProfileType :: Text
...
instance Arbitrary V1AuditAnnotation where
  arbitrary = sized genV1AuditAnnotation

genV1AuditAnnotation :: Int -> Gen V1AuditAnnotation
genV1AuditAnnotation n =
  V1AuditAnnotation
    <$> arbitrary -- v1AuditAnnotationKey :: Text
    <*> arbitrary -- v1AuditAnnotationValueExpression :: Text
...
genV1ContainerStatus n =
  V1ContainerStatus
    ...
    <*> arbitraryReducedMaybe n -- v1ContainerStatusVolumeMounts :: Maybe [V1VolumeMountStatus]
...
genV1CustomResourceDefinitionVersion n =
  V1CustomResourceDefinitionVersion
    ...
    <*> arbitraryReducedMaybe n -- v1CustomResourceDefinitionVersionSelectableFields :: Maybe [V1SelectableField]
...
instance Arbitrary V1ExpressionWarning where
  arbitrary = sized genV1ExpressionWarning

genV1ExpressionWarning :: Int -> Gen V1ExpressionWarning
genV1ExpressionWarning n =
  V1ExpressionWarning
    <$> arbitrary -- v1ExpressionWarningFieldRef :: Text
    <*> arbitrary -- v1ExpressionWarningWarning :: Text
...
genV1JobSpec n =
  V1JobSpec
    ...
    <*> arbitraryReducedMaybe n -- v1JobSpecManagedBy :: Maybe Text
    ...
    <*> arbitraryReducedMaybe n -- v1JobSpecSuccessPolicy :: Maybe V1SuccessPolicy
...
instance Arbitrary V1MatchResources where
  arbitrary = sized genV1MatchResources

genV1MatchResources :: Int -> Gen V1MatchResources
genV1MatchResources n =
  V1MatchResources
    <$> arbitraryReducedMaybe n -- v1MatchResourcesExcludeResourceRules :: Maybe [V1NamedRuleWithOperations]
    <*> arbitraryReducedMaybe n -- v1MatchResourcesMatchPolicy :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1MatchResourcesNamespaceSelector :: Maybe V1LabelSelector
    <*> arbitraryReducedMaybe n -- v1MatchResourcesObjectSelector :: Maybe V1LabelSelector
    <*> arbitraryReducedMaybe n -- v1MatchResourcesResourceRules :: Maybe [V1NamedRuleWithOperations]
...
instance Arbitrary V1NamedRuleWithOperations where
  arbitrary = sized genV1NamedRuleWithOperations

genV1NamedRuleWithOperations :: Int -> Gen V1NamedRuleWithOperations
genV1NamedRuleWithOperations n =
  V1NamedRuleWithOperations
    <$> arbitraryReducedMaybe n -- v1NamedRuleWithOperationsApiGroups :: Maybe [Text]
    <*> arbitraryReducedMaybe n -- v1NamedRuleWithOperationsApiVersions :: Maybe [Text]
    <*> arbitraryReducedMaybe n -- v1NamedRuleWithOperationsOperations :: Maybe [Text]
    <*> arbitraryReducedMaybe n -- v1NamedRuleWithOperationsResourceNames :: Maybe [Text]
    <*> arbitraryReducedMaybe n -- v1NamedRuleWithOperationsResources :: Maybe [Text]
    <*> arbitraryReducedMaybe n -- v1NamedRuleWithOperationsScope :: Maybe Text
...
instance Arbitrary V1NodeRuntimeHandler where
  arbitrary = sized genV1NodeRuntimeHandler

genV1NodeRuntimeHandler :: Int -> Gen V1NodeRuntimeHandler
genV1NodeRuntimeHandler n =
  V1NodeRuntimeHandler
    <$> arbitraryReducedMaybe n -- v1NodeRuntimeHandlerFeatures :: Maybe V1NodeRuntimeHandlerFeatures
    <*> arbitraryReducedMaybe n -- v1NodeRuntimeHandlerName :: Maybe Text
  
instance Arbitrary V1NodeRuntimeHandlerFeatures where
  arbitrary = sized genV1NodeRuntimeHandlerFeatures

genV1NodeRuntimeHandlerFeatures :: Int -> Gen V1NodeRuntimeHandlerFeatures
genV1NodeRuntimeHandlerFeatures n =
  V1NodeRuntimeHandlerFeatures
    <$> arbitraryReducedMaybe n -- v1NodeRuntimeHandlerFeaturesRecursiveReadOnlyMounts :: Maybe Bool
...
genV1NodeStatus n =
  V1NodeStatus
    ...
    <*> arbitraryReducedMaybe n -- v1NodeStatusRuntimeHandlers :: Maybe [V1NodeRuntimeHandler]
...
instance Arbitrary V1ParamKind where
  arbitrary = sized genV1ParamKind

genV1ParamKind :: Int -> Gen V1ParamKind
genV1ParamKind n =
  V1ParamKind
    <$> arbitraryReducedMaybe n -- v1ParamKindApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1ParamKindKind :: Maybe Text
  
instance Arbitrary V1ParamRef where
  arbitrary = sized genV1ParamRef

genV1ParamRef :: Int -> Gen V1ParamRef
genV1ParamRef n =
  V1ParamRef
    <$> arbitraryReducedMaybe n -- v1ParamRefName :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1ParamRefNamespace :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1ParamRefParameterNotFoundAction :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1ParamRefSelector :: Maybe V1LabelSelector
...
genV1PodSecurityContext n =
  V1PodSecurityContext
    <$> arbitraryReducedMaybe n -- v1PodSecurityContextAppArmorProfile :: Maybe V1AppArmorProfile
...
genV1SecurityContext n =
  V1SecurityContext
    ...
    <*> arbitraryReducedMaybe n -- v1SecurityContextAppArmorProfile :: Maybe V1AppArmorProfile
...
instance Arbitrary V1SelectableField where
  arbitrary = sized genV1SelectableField

genV1SelectableField :: Int -> Gen V1SelectableField
genV1SelectableField n =
  V1SelectableField
    <$> arbitrary -- v1SelectableFieldJsonPath :: Text
...
genV1ServiceSpec n =
  V1ServiceSpec
    ...
    <*> arbitraryReducedMaybe n -- v1ServiceSpecTrafficDistribution :: Maybe Text
...
instance Arbitrary V1SuccessPolicy where
  arbitrary = sized genV1SuccessPolicy

genV1SuccessPolicy :: Int -> Gen V1SuccessPolicy
genV1SuccessPolicy n =
  V1SuccessPolicy
    <$> arbitraryReduced n -- v1SuccessPolicyRules :: [V1SuccessPolicyRule]
  
instance Arbitrary V1SuccessPolicyRule where
  arbitrary = sized genV1SuccessPolicyRule

genV1SuccessPolicyRule :: Int -> Gen V1SuccessPolicyRule
genV1SuccessPolicyRule n =
  V1SuccessPolicyRule
    <$> arbitraryReducedMaybe n -- v1SuccessPolicyRuleSucceededCount :: Maybe Int
    <*> arbitraryReducedMaybe n -- v1SuccessPolicyRuleSucceededIndexes :: Maybe Text
...
instance Arbitrary V1TypeChecking where
  arbitrary = sized genV1TypeChecking

genV1TypeChecking :: Int -> Gen V1TypeChecking
genV1TypeChecking n =
  V1TypeChecking
    <$> arbitraryReducedMaybe n -- v1TypeCheckingExpressionWarnings :: Maybe [V1ExpressionWarning]
...
instance Arbitrary V1ValidatingAdmissionPolicy where
  arbitrary = sized genV1ValidatingAdmissionPolicy

genV1ValidatingAdmissionPolicy :: Int -> Gen V1ValidatingAdmissionPolicy
genV1ValidatingAdmissionPolicy n =
  V1ValidatingAdmissionPolicy
    <$> arbitraryReducedMaybe n -- v1ValidatingAdmissionPolicyApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1ValidatingAdmissionPolicyKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1ValidatingAdmissionPolicyMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReducedMaybe n -- v1ValidatingAdmissionPolicySpec :: Maybe V1ValidatingAdmissionPolicySpec
    <*> arbitraryReducedMaybe n -- v1ValidatingAdmissionPolicyStatus :: Maybe V1ValidatingAdmissionPolicyStatus
  
instance Arbitrary V1ValidatingAdmissionPolicyBinding where
  arbitrary = sized genV1ValidatingAdmissionPolicyBinding

genV1ValidatingAdmissionPolicyBinding :: Int -> Gen V1ValidatingAdmissionPolicyBinding
genV1ValidatingAdmissionPolicyBinding n =
  V1ValidatingAdmissionPolicyBinding
    <$> arbitraryReducedMaybe n -- v1ValidatingAdmissionPolicyBindingApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1ValidatingAdmissionPolicyBindingKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1ValidatingAdmissionPolicyBindingMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReducedMaybe n -- v1ValidatingAdmissionPolicyBindingSpec :: Maybe V1ValidatingAdmissionPolicyBindingSpec
  
instance Arbitrary V1ValidatingAdmissionPolicyBindingList where
  arbitrary = sized genV1ValidatingAdmissionPolicyBindingList

genV1ValidatingAdmissionPolicyBindingList :: Int -> Gen V1ValidatingAdmissionPolicyBindingList
genV1ValidatingAdmissionPolicyBindingList n =
  V1ValidatingAdmissionPolicyBindingList
    <$> arbitraryReducedMaybe n -- v1ValidatingAdmissionPolicyBindingListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1ValidatingAdmissionPolicyBindingListItems :: [V1ValidatingAdmissionPolicyBinding]
    <*> arbitraryReducedMaybe n -- v1ValidatingAdmissionPolicyBindingListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1ValidatingAdmissionPolicyBindingListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1ValidatingAdmissionPolicyBindingSpec where
  arbitrary = sized genV1ValidatingAdmissionPolicyBindingSpec

genV1ValidatingAdmissionPolicyBindingSpec :: Int -> Gen V1ValidatingAdmissionPolicyBindingSpec
genV1ValidatingAdmissionPolicyBindingSpec n =
  V1ValidatingAdmissionPolicyBindingSpec
    <$> arbitraryReducedMaybe n -- v1ValidatingAdmissionPolicyBindingSpecMatchResources :: Maybe V1MatchResources
    <*> arbitraryReducedMaybe n -- v1ValidatingAdmissionPolicyBindingSpecParamRef :: Maybe V1ParamRef
    <*> arbitraryReducedMaybe n -- v1ValidatingAdmissionPolicyBindingSpecPolicyName :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1ValidatingAdmissionPolicyBindingSpecValidationActions :: Maybe [Text]
  
instance Arbitrary V1ValidatingAdmissionPolicyList where
  arbitrary = sized genV1ValidatingAdmissionPolicyList

genV1ValidatingAdmissionPolicyList :: Int -> Gen V1ValidatingAdmissionPolicyList
genV1ValidatingAdmissionPolicyList n =
  V1ValidatingAdmissionPolicyList
    <$> arbitraryReducedMaybe n -- v1ValidatingAdmissionPolicyListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1ValidatingAdmissionPolicyListItems :: [V1ValidatingAdmissionPolicy]
    <*> arbitraryReducedMaybe n -- v1ValidatingAdmissionPolicyListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1ValidatingAdmissionPolicyListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1ValidatingAdmissionPolicySpec where
  arbitrary = sized genV1ValidatingAdmissionPolicySpec

genV1ValidatingAdmissionPolicySpec :: Int -> Gen V1ValidatingAdmissionPolicySpec
genV1ValidatingAdmissionPolicySpec n =
  V1ValidatingAdmissionPolicySpec
    <$> arbitraryReducedMaybe n -- v1ValidatingAdmissionPolicySpecAuditAnnotations :: Maybe [V1AuditAnnotation]
    <*> arbitraryReducedMaybe n -- v1ValidatingAdmissionPolicySpecFailurePolicy :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1ValidatingAdmissionPolicySpecMatchConditions :: Maybe [V1MatchCondition]
    <*> arbitraryReducedMaybe n -- v1ValidatingAdmissionPolicySpecMatchConstraints :: Maybe V1MatchResources
    <*> arbitraryReducedMaybe n -- v1ValidatingAdmissionPolicySpecParamKind :: Maybe V1ParamKind
    <*> arbitraryReducedMaybe n -- v1ValidatingAdmissionPolicySpecValidations :: Maybe [V1Validation]
    <*> arbitraryReducedMaybe n -- v1ValidatingAdmissionPolicySpecVariables :: Maybe [V1Variable]
  
instance Arbitrary V1ValidatingAdmissionPolicyStatus where
  arbitrary = sized genV1ValidatingAdmissionPolicyStatus

genV1ValidatingAdmissionPolicyStatus :: Int -> Gen V1ValidatingAdmissionPolicyStatus
genV1ValidatingAdmissionPolicyStatus n =
  V1ValidatingAdmissionPolicyStatus
    <$> arbitraryReducedMaybe n -- v1ValidatingAdmissionPolicyStatusConditions :: Maybe [V1Condition]
    <*> arbitraryReducedMaybe n -- v1ValidatingAdmissionPolicyStatusObservedGeneration :: Maybe Integer
    <*> arbitraryReducedMaybe n -- v1ValidatingAdmissionPolicyStatusTypeChecking :: Maybe V1TypeChecking
...
instance Arbitrary V1Validation where
  arbitrary = sized genV1Validation

genV1Validation :: Int -> Gen V1Validation
genV1Validation n =
  V1Validation
    <$> arbitrary -- v1ValidationExpression :: Text
    <*> arbitraryReducedMaybe n -- v1ValidationMessage :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1ValidationMessageExpression :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1ValidationReason :: Maybe Text
...
instance Arbitrary V1Variable where
  arbitrary = sized genV1Variable

genV1Variable :: Int -> Gen V1Variable
genV1Variable n =
  V1Variable
    <$> arbitrary -- v1VariableExpression :: Text
    <*> arbitrary -- v1VariableName :: Text
...
genV1VolumeMount n =
  V1VolumeMount
    ...
    <*> arbitraryReducedMaybe n -- v1VolumeMountRecursiveReadOnly :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1VolumeMountSubPath :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1VolumeMountSubPathExpr :: Maybe Text
  
instance Arbitrary V1VolumeMountStatus where
  arbitrary = sized genV1VolumeMountStatus

genV1VolumeMountStatus :: Int -> Gen V1VolumeMountStatus
genV1VolumeMountStatus n =
  V1VolumeMountStatus
    <$> arbitrary -- v1VolumeMountStatusMountPath :: Text
    <*> arbitrary -- v1VolumeMountStatusName :: Text
    <*> arbitraryReducedMaybe n -- v1VolumeMountStatusReadOnly :: Maybe Bool
    <*> arbitraryReducedMaybe n -- v1VolumeMountStatusRecursiveReadOnly :: Maybe Text
...
instance Arbitrary V1alpha1GroupVersionResource where
  arbitrary = sized genV1alpha1GroupVersionResource

genV1alpha1GroupVersionResource :: Int -> Gen V1alpha1GroupVersionResource
genV1alpha1GroupVersionResource n =
  V1alpha1GroupVersionResource
    <$> arbitraryReducedMaybe n -- v1alpha1GroupVersionResourceGroup :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha1GroupVersionResourceResource :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha1GroupVersionResourceVersion :: Maybe Text
...
genV1alpha1IPAddressSpec n =
  V1alpha1IPAddressSpec
    <$> arbitraryReduced n -- v1alpha1IPAddressSpecParentRef :: V1alpha1ParentReference
...
instance Arbitrary V1alpha1MigrationCondition where
  arbitrary = sized genV1alpha1MigrationCondition

genV1alpha1MigrationCondition :: Int -> Gen V1alpha1MigrationCondition
genV1alpha1MigrationCondition n =
  V1alpha1MigrationCondition
    <$> arbitraryReducedMaybe n -- v1alpha1MigrationConditionLastUpdateTime :: Maybe DateTime
    <*> arbitraryReducedMaybe n -- v1alpha1MigrationConditionMessage :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha1MigrationConditionReason :: Maybe Text
    <*> arbitrary -- v1alpha1MigrationConditionStatus :: Text
    <*> arbitrary -- v1alpha1MigrationConditionType :: Text
...
genV1alpha1ParentReference n =
  V1alpha1ParentReference
    ...
    <*> arbitrary -- v1alpha1ParentReferenceName :: Text
    <*> arbitraryReducedMaybe n -- v1alpha1ParentReferenceNamespace :: Maybe Text
    <*> arbitrary -- v1alpha1ParentReferenceResource :: Text
...
genV1alpha1StorageVersionCondition n =
  V1alpha1StorageVersionCondition
    ...
    <*> arbitrary -- v1alpha1StorageVersionConditionMessage :: Text
...
instance Arbitrary V1alpha1StorageVersionMigration where
  arbitrary = sized genV1alpha1StorageVersionMigration

genV1alpha1StorageVersionMigration :: Int -> Gen V1alpha1StorageVersionMigration
genV1alpha1StorageVersionMigration n =
  V1alpha1StorageVersionMigration
    <$> arbitraryReducedMaybe n -- v1alpha1StorageVersionMigrationApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha1StorageVersionMigrationKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha1StorageVersionMigrationMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReducedMaybe n -- v1alpha1StorageVersionMigrationSpec :: Maybe V1alpha1StorageVersionMigrationSpec
    <*> arbitraryReducedMaybe n -- v1alpha1StorageVersionMigrationStatus :: Maybe V1alpha1StorageVersionMigrationStatus
  
instance Arbitrary V1alpha1StorageVersionMigrationList where
  arbitrary = sized genV1alpha1StorageVersionMigrationList

genV1alpha1StorageVersionMigrationList :: Int -> Gen V1alpha1StorageVersionMigrationList
genV1alpha1StorageVersionMigrationList n =
  V1alpha1StorageVersionMigrationList
    <$> arbitraryReducedMaybe n -- v1alpha1StorageVersionMigrationListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1alpha1StorageVersionMigrationListItems :: [V1alpha1StorageVersionMigration]
    <*> arbitraryReducedMaybe n -- v1alpha1StorageVersionMigrationListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha1StorageVersionMigrationListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1alpha1StorageVersionMigrationSpec where
  arbitrary = sized genV1alpha1StorageVersionMigrationSpec

genV1alpha1StorageVersionMigrationSpec :: Int -> Gen V1alpha1StorageVersionMigrationSpec
genV1alpha1StorageVersionMigrationSpec n =
  V1alpha1StorageVersionMigrationSpec
    <$> arbitraryReducedMaybe n -- v1alpha1StorageVersionMigrationSpecContinueToken :: Maybe Text
    <*> arbitraryReduced n -- v1alpha1StorageVersionMigrationSpecResource :: V1alpha1GroupVersionResource
  
instance Arbitrary V1alpha1StorageVersionMigrationStatus where
  arbitrary = sized genV1alpha1StorageVersionMigrationStatus

genV1alpha1StorageVersionMigrationStatus :: Int -> Gen V1alpha1StorageVersionMigrationStatus
genV1alpha1StorageVersionMigrationStatus n =
  V1alpha1StorageVersionMigrationStatus
    <$> arbitraryReducedMaybe n -- v1alpha1StorageVersionMigrationStatusConditions :: Maybe [V1alpha1MigrationCondition]
    <*> arbitraryReducedMaybe n -- v1alpha1StorageVersionMigrationStatusResourceVersion :: Maybe Text
...
genV1alpha1ValidatingAdmissionPolicyBindingList n =
  V1alpha1ValidatingAdmissionPolicyBindingList
    ...
    <*> arbitraryReduced n -- v1alpha1ValidatingAdmissionPolicyBindingListItems :: [V1alpha1ValidatingAdmissionPolicyBinding]
...
genV1alpha1ValidatingAdmissionPolicyList n =
  V1alpha1ValidatingAdmissionPolicyList
    ...
    <*> arbitraryReduced n -- v1alpha1ValidatingAdmissionPolicyListItems :: [V1alpha1ValidatingAdmissionPolicy]
...
instance Arbitrary V1alpha2DriverAllocationResult where
  arbitrary = sized genV1alpha2DriverAllocationResult

genV1alpha2DriverAllocationResult :: Int -> Gen V1alpha2DriverAllocationResult
genV1alpha2DriverAllocationResult n =
  V1alpha2DriverAllocationResult
    <$> arbitraryReducedMaybe n -- v1alpha2DriverAllocationResultNamedResources :: Maybe V1alpha2NamedResourcesAllocationResult
    <*> arbitraryReducedMaybeValue n -- v1alpha2DriverAllocationResultVendorRequestParameters :: Maybe A.Value
  
instance Arbitrary V1alpha2DriverRequests where
  arbitrary = sized genV1alpha2DriverRequests

genV1alpha2DriverRequests :: Int -> Gen V1alpha2DriverRequests
genV1alpha2DriverRequests n =
  V1alpha2DriverRequests
    <$> arbitraryReducedMaybe n -- v1alpha2DriverRequestsDriverName :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha2DriverRequestsRequests :: Maybe [V1alpha2ResourceRequest]
    <*> arbitraryReducedMaybeValue n -- v1alpha2DriverRequestsVendorParameters :: Maybe A.Value
  
instance Arbitrary V1alpha2NamedResourcesAllocationResult where
  arbitrary = sized genV1alpha2NamedResourcesAllocationResult

genV1alpha2NamedResourcesAllocationResult :: Int -> Gen V1alpha2NamedResourcesAllocationResult
genV1alpha2NamedResourcesAllocationResult n =
  V1alpha2NamedResourcesAllocationResult
    <$> arbitrary -- v1alpha2NamedResourcesAllocationResultName :: Text
  
instance Arbitrary V1alpha2NamedResourcesAttribute where
  arbitrary = sized genV1alpha2NamedResourcesAttribute

genV1alpha2NamedResourcesAttribute :: Int -> Gen V1alpha2NamedResourcesAttribute
genV1alpha2NamedResourcesAttribute n =
  V1alpha2NamedResourcesAttribute
    <$> arbitraryReducedMaybe n -- v1alpha2NamedResourcesAttributeBool :: Maybe Bool
    <*> arbitraryReducedMaybe n -- v1alpha2NamedResourcesAttributeInt :: Maybe Integer
    <*> arbitraryReducedMaybe n -- v1alpha2NamedResourcesAttributeIntSlice :: Maybe V1alpha2NamedResourcesIntSlice
    <*> arbitrary -- v1alpha2NamedResourcesAttributeName :: Text
    <*> arbitraryReducedMaybe n -- v1alpha2NamedResourcesAttributeQuantity :: Maybe Quantity
    <*> arbitraryReducedMaybe n -- v1alpha2NamedResourcesAttributeString :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha2NamedResourcesAttributeStringSlice :: Maybe V1alpha2NamedResourcesStringSlice
    <*> arbitraryReducedMaybe n -- v1alpha2NamedResourcesAttributeVersion :: Maybe Text
  
instance Arbitrary V1alpha2NamedResourcesFilter where
  arbitrary = sized genV1alpha2NamedResourcesFilter

genV1alpha2NamedResourcesFilter :: Int -> Gen V1alpha2NamedResourcesFilter
genV1alpha2NamedResourcesFilter n =
  V1alpha2NamedResourcesFilter
    <$> arbitrary -- v1alpha2NamedResourcesFilterSelector :: Text
  
instance Arbitrary V1alpha2NamedResourcesInstance where
  arbitrary = sized genV1alpha2NamedResourcesInstance

genV1alpha2NamedResourcesInstance :: Int -> Gen V1alpha2NamedResourcesInstance
genV1alpha2NamedResourcesInstance n =
  V1alpha2NamedResourcesInstance
    <$> arbitraryReducedMaybe n -- v1alpha2NamedResourcesInstanceAttributes :: Maybe [V1alpha2NamedResourcesAttribute]
    <*> arbitrary -- v1alpha2NamedResourcesInstanceName :: Text
  
instance Arbitrary V1alpha2NamedResourcesIntSlice where
  arbitrary = sized genV1alpha2NamedResourcesIntSlice

genV1alpha2NamedResourcesIntSlice :: Int -> Gen V1alpha2NamedResourcesIntSlice
genV1alpha2NamedResourcesIntSlice n =
  V1alpha2NamedResourcesIntSlice
    <$> arbitrary -- v1alpha2NamedResourcesIntSliceInts :: [Integer]
  
instance Arbitrary V1alpha2NamedResourcesRequest where
  arbitrary = sized genV1alpha2NamedResourcesRequest

genV1alpha2NamedResourcesRequest :: Int -> Gen V1alpha2NamedResourcesRequest
genV1alpha2NamedResourcesRequest n =
  V1alpha2NamedResourcesRequest
    <$> arbitrary -- v1alpha2NamedResourcesRequestSelector :: Text
  
instance Arbitrary V1alpha2NamedResourcesResources where
  arbitrary = sized genV1alpha2NamedResourcesResources

genV1alpha2NamedResourcesResources :: Int -> Gen V1alpha2NamedResourcesResources
genV1alpha2NamedResourcesResources n =
  V1alpha2NamedResourcesResources
    <$> arbitraryReduced n -- v1alpha2NamedResourcesResourcesInstances :: [V1alpha2NamedResourcesInstance]
  
instance Arbitrary V1alpha2NamedResourcesStringSlice where
  arbitrary = sized genV1alpha2NamedResourcesStringSlice

genV1alpha2NamedResourcesStringSlice :: Int -> Gen V1alpha2NamedResourcesStringSlice
genV1alpha2NamedResourcesStringSlice n =
  V1alpha2NamedResourcesStringSlice
    <$> arbitrary -- v1alpha2NamedResourcesStringSliceStrings :: [Text]
...
instance Arbitrary V1alpha2ResourceClaimParameters where
  arbitrary = sized genV1alpha2ResourceClaimParameters

genV1alpha2ResourceClaimParameters :: Int -> Gen V1alpha2ResourceClaimParameters
genV1alpha2ResourceClaimParameters n =
  V1alpha2ResourceClaimParameters
    <$> arbitraryReducedMaybe n -- v1alpha2ResourceClaimParametersApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha2ResourceClaimParametersDriverRequests :: Maybe [V1alpha2DriverRequests]
    <*> arbitraryReducedMaybe n -- v1alpha2ResourceClaimParametersGeneratedFrom :: Maybe V1alpha2ResourceClaimParametersReference
    <*> arbitraryReducedMaybe n -- v1alpha2ResourceClaimParametersKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha2ResourceClaimParametersMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReducedMaybe n -- v1alpha2ResourceClaimParametersShareable :: Maybe Bool
  
instance Arbitrary V1alpha2ResourceClaimParametersList where
  arbitrary = sized genV1alpha2ResourceClaimParametersList

genV1alpha2ResourceClaimParametersList :: Int -> Gen V1alpha2ResourceClaimParametersList
genV1alpha2ResourceClaimParametersList n =
  V1alpha2ResourceClaimParametersList
    <$> arbitraryReducedMaybe n -- v1alpha2ResourceClaimParametersListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1alpha2ResourceClaimParametersListItems :: [V1alpha2ResourceClaimParameters]
    <*> arbitraryReducedMaybe n -- v1alpha2ResourceClaimParametersListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha2ResourceClaimParametersListMetadata :: Maybe V1ListMeta
...
genV1alpha2ResourceClass n =
  V1alpha2ResourceClass
    ...
    <*> arbitraryReducedMaybe n -- v1alpha2ResourceClassStructuredParameters :: Maybe Bool
...
instance Arbitrary V1alpha2ResourceClassParameters where
  arbitrary = sized genV1alpha2ResourceClassParameters

genV1alpha2ResourceClassParameters :: Int -> Gen V1alpha2ResourceClassParameters
genV1alpha2ResourceClassParameters n =
  V1alpha2ResourceClassParameters
    <$> arbitraryReducedMaybe n -- v1alpha2ResourceClassParametersApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha2ResourceClassParametersFilters :: Maybe [V1alpha2ResourceFilter]
    <*> arbitraryReducedMaybe n -- v1alpha2ResourceClassParametersGeneratedFrom :: Maybe V1alpha2ResourceClassParametersReference
    <*> arbitraryReducedMaybe n -- v1alpha2ResourceClassParametersKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha2ResourceClassParametersMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReducedMaybe n -- v1alpha2ResourceClassParametersVendorParameters :: Maybe [V1alpha2VendorParameters]
  
instance Arbitrary V1alpha2ResourceClassParametersList where
  arbitrary = sized genV1alpha2ResourceClassParametersList

genV1alpha2ResourceClassParametersList :: Int -> Gen V1alpha2ResourceClassParametersList
genV1alpha2ResourceClassParametersList n =
  V1alpha2ResourceClassParametersList
    <$> arbitraryReducedMaybe n -- v1alpha2ResourceClassParametersListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1alpha2ResourceClassParametersListItems :: [V1alpha2ResourceClassParameters]
    <*> arbitraryReducedMaybe n -- v1alpha2ResourceClassParametersListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha2ResourceClassParametersListMetadata :: Maybe V1ListMeta
...
instance Arbitrary V1alpha2ResourceFilter where
  arbitrary = sized genV1alpha2ResourceFilter

genV1alpha2ResourceFilter :: Int -> Gen V1alpha2ResourceFilter
genV1alpha2ResourceFilter n =
  V1alpha2ResourceFilter
    <$> arbitraryReducedMaybe n -- v1alpha2ResourceFilterDriverName :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha2ResourceFilterNamedResources :: Maybe V1alpha2NamedResourcesFilter
...
genV1alpha2ResourceHandle n =
  V1alpha2ResourceHandle
    ...
    <*> arbitraryReducedMaybe n -- v1alpha2ResourceHandleStructuredData :: Maybe V1alpha2StructuredResourceHandle
  
instance Arbitrary V1alpha2ResourceRequest where
  arbitrary = sized genV1alpha2ResourceRequest

genV1alpha2ResourceRequest :: Int -> Gen V1alpha2ResourceRequest
genV1alpha2ResourceRequest n =
  V1alpha2ResourceRequest
    <$> arbitraryReducedMaybe n -- v1alpha2ResourceRequestNamedResources :: Maybe V1alpha2NamedResourcesRequest
    <*> arbitraryReducedMaybeValue n -- v1alpha2ResourceRequestVendorParameters :: Maybe A.Value
  
instance Arbitrary V1alpha2ResourceSlice where
  arbitrary = sized genV1alpha2ResourceSlice

genV1alpha2ResourceSlice :: Int -> Gen V1alpha2ResourceSlice
genV1alpha2ResourceSlice n =
  V1alpha2ResourceSlice
    <$> arbitraryReducedMaybe n -- v1alpha2ResourceSliceApiVersion :: Maybe Text
    <*> arbitrary -- v1alpha2ResourceSliceDriverName :: Text
    <*> arbitraryReducedMaybe n -- v1alpha2ResourceSliceKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha2ResourceSliceMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReducedMaybe n -- v1alpha2ResourceSliceNamedResources :: Maybe V1alpha2NamedResourcesResources
    <*> arbitraryReducedMaybe n -- v1alpha2ResourceSliceNodeName :: Maybe Text
  
instance Arbitrary V1alpha2ResourceSliceList where
  arbitrary = sized genV1alpha2ResourceSliceList

genV1alpha2ResourceSliceList :: Int -> Gen V1alpha2ResourceSliceList
genV1alpha2ResourceSliceList n =
  V1alpha2ResourceSliceList
    <$> arbitraryReducedMaybe n -- v1alpha2ResourceSliceListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1alpha2ResourceSliceListItems :: [V1alpha2ResourceSlice]
    <*> arbitraryReducedMaybe n -- v1alpha2ResourceSliceListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha2ResourceSliceListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1alpha2StructuredResourceHandle where
  arbitrary = sized genV1alpha2StructuredResourceHandle

genV1alpha2StructuredResourceHandle :: Int -> Gen V1alpha2StructuredResourceHandle
genV1alpha2StructuredResourceHandle n =
  V1alpha2StructuredResourceHandle
    <$> arbitraryReducedMaybe n -- v1alpha2StructuredResourceHandleNodeName :: Maybe Text
    <*> arbitraryReduced n -- v1alpha2StructuredResourceHandleResults :: [V1alpha2DriverAllocationResult]
    <*> arbitraryReducedMaybeValue n -- v1alpha2StructuredResourceHandleVendorClaimParameters :: Maybe A.Value
    <*> arbitraryReducedMaybeValue n -- v1alpha2StructuredResourceHandleVendorClassParameters :: Maybe A.Value
  
instance Arbitrary V1alpha2VendorParameters where
  arbitrary = sized genV1alpha2VendorParameters

genV1alpha2VendorParameters :: Int -> Gen V1alpha2VendorParameters
genV1alpha2VendorParameters n =
  V1alpha2VendorParameters
    <$> arbitraryReducedMaybe n -- v1alpha2VendorParametersDriverName :: Maybe Text
    <*> arbitraryReducedMaybeValue n -- v1alpha2VendorParametersParameters :: Maybe A.Value
...
genV1beta1ValidatingAdmissionPolicyBindingList n =
  V1beta1ValidatingAdmissionPolicyBindingList
    ...
    <*> arbitraryReduced n -- v1beta1ValidatingAdmissionPolicyBindingListItems :: [V1beta1ValidatingAdmissionPolicyBinding]
...
genV1beta1ValidatingAdmissionPolicyList n =
  V1beta1ValidatingAdmissionPolicyList
    ...
    <*> arbitraryReduced n -- v1beta1ValidatingAdmissionPolicyListItems :: [V1beta1ValidatingAdmissionPolicy]
