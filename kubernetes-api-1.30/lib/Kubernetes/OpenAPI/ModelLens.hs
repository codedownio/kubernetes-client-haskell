...
flowcontrolV1SubjectGroupL f FlowcontrolV1Subject{..} = (\flowcontrolV1SubjectGroup -> FlowcontrolV1Subject { flowcontrolV1SubjectGroup, ..} ) <$> f flowcontrolV1SubjectGroup
{-# INLINE flowcontrolV1SubjectGroupL #-}

-- | 'flowcontrolV1SubjectKind' Lens
flowcontrolV1SubjectKindL :: Lens_' FlowcontrolV1Subject (Text)
flowcontrolV1SubjectKindL f FlowcontrolV1Subject{..} = (\flowcontrolV1SubjectKind -> FlowcontrolV1Subject { flowcontrolV1SubjectKind, ..} ) <$> f flowcontrolV1SubjectKind
...
flowcontrolV1SubjectServiceAccountL f FlowcontrolV1Subject{..} = (\flowcontrolV1SubjectServiceAccount -> FlowcontrolV1Subject { flowcontrolV1SubjectServiceAccount, ..} ) <$> f flowcontrolV1SubjectServiceAccount
...
flowcontrolV1SubjectUserL f FlowcontrolV1Subject{..} = (\flowcontrolV1SubjectUser -> FlowcontrolV1Subject { flowcontrolV1SubjectUser, ..} ) <$> f flowcontrolV1SubjectUser
...
rbacV1SubjectApiGroupL f RbacV1Subject{..} = (\rbacV1SubjectApiGroup -> RbacV1Subject { rbacV1SubjectApiGroup, ..} ) <$> f rbacV1SubjectApiGroup
{-# INLINE rbacV1SubjectApiGroupL #-}

-- | 'rbacV1SubjectKind' Lens
rbacV1SubjectKindL :: Lens_' RbacV1Subject (Text)
rbacV1SubjectKindL f RbacV1Subject{..} = (\rbacV1SubjectKind -> RbacV1Subject { rbacV1SubjectKind, ..} ) <$> f rbacV1SubjectKind
{-# INLINE rbacV1SubjectKindL #-}

-- | 'rbacV1SubjectName' Lens
rbacV1SubjectNameL :: Lens_' RbacV1Subject (Text)
rbacV1SubjectNameL f RbacV1Subject{..} = (\rbacV1SubjectName -> RbacV1Subject { rbacV1SubjectName, ..} ) <$> f rbacV1SubjectName
{-# INLINE rbacV1SubjectNameL #-}

-- | 'rbacV1SubjectNamespace' Lens
rbacV1SubjectNamespaceL :: Lens_' RbacV1Subject (Maybe Text)
rbacV1SubjectNamespaceL f RbacV1Subject{..} = (\rbacV1SubjectNamespace -> RbacV1Subject { rbacV1SubjectNamespace, ..} ) <$> f rbacV1SubjectNamespace
...
v1AppArmorProfileLocalhostProfileL f V1AppArmorProfile{..} = (\v1AppArmorProfileLocalhostProfile -> V1AppArmorProfile { v1AppArmorProfileLocalhostProfile, ..} ) <$> f v1AppArmorProfileLocalhostProfile
{-# INLINE v1AppArmorProfileLocalhostProfileL #-}

-- | 'v1AppArmorProfileType' Lens
v1AppArmorProfileTypeL :: Lens_' V1AppArmorProfile (Text)
v1AppArmorProfileTypeL f V1AppArmorProfile{..} = (\v1AppArmorProfileType -> V1AppArmorProfile { v1AppArmorProfileType, ..} ) <$> f v1AppArmorProfileType
...
v1AuditAnnotationKeyL f V1AuditAnnotation{..} = (\v1AuditAnnotationKey -> V1AuditAnnotation { v1AuditAnnotationKey, ..} ) <$> f v1AuditAnnotationKey
...
v1AuditAnnotationValueExpressionL f V1AuditAnnotation{..} = (\v1AuditAnnotationValueExpression -> V1AuditAnnotation { v1AuditAnnotationValueExpression, ..} ) <$> f v1AuditAnnotationValueExpression
...
v1ClusterTrustBundleProjectionLabelSelectorL f V1ClusterTrustBundleProjection{..} = (\v1ClusterTrustBundleProjectionLabelSelector -> V1ClusterTrustBundleProjection { v1ClusterTrustBundleProjectionLabelSelector, ..} ) <$> f v1ClusterTrustBundleProjectionLabelSelector
...
v1ClusterTrustBundleProjectionNameL f V1ClusterTrustBundleProjection{..} = (\v1ClusterTrustBundleProjectionName -> V1ClusterTrustBundleProjection { v1ClusterTrustBundleProjectionName, ..} ) <$> f v1ClusterTrustBundleProjectionName
...
v1ClusterTrustBundleProjectionOptionalL f V1ClusterTrustBundleProjection{..} = (\v1ClusterTrustBundleProjectionOptional -> V1ClusterTrustBundleProjection { v1ClusterTrustBundleProjectionOptional, ..} ) <$> f v1ClusterTrustBundleProjectionOptional
...
v1ClusterTrustBundleProjectionPathL f V1ClusterTrustBundleProjection{..} = (\v1ClusterTrustBundleProjectionPath -> V1ClusterTrustBundleProjection { v1ClusterTrustBundleProjectionPath, ..} ) <$> f v1ClusterTrustBundleProjectionPath
...
v1ClusterTrustBundleProjectionSignerNameL f V1ClusterTrustBundleProjection{..} = (\v1ClusterTrustBundleProjectionSignerName -> V1ClusterTrustBundleProjection { v1ClusterTrustBundleProjectionSignerName, ..} ) <$> f v1ClusterTrustBundleProjectionSignerName
...
v1ContainerStatusVolumeMountsL f V1ContainerStatus{..} = (\v1ContainerStatusVolumeMounts -> V1ContainerStatus { v1ContainerStatusVolumeMounts, ..} ) <$> f v1ContainerStatusVolumeMounts
...
v1CustomResourceDefinitionVersionSelectableFieldsL f V1CustomResourceDefinitionVersion{..} = (\v1CustomResourceDefinitionVersionSelectableFields -> V1CustomResourceDefinitionVersion { v1CustomResourceDefinitionVersionSelectableFields, ..} ) <$> f v1CustomResourceDefinitionVersionSelectableFields
...
v1ExemptPriorityLevelConfigurationLendablePercentL f V1ExemptPriorityLevelConfiguration{..} = (\v1ExemptPriorityLevelConfigurationLendablePercent -> V1ExemptPriorityLevelConfiguration { v1ExemptPriorityLevelConfigurationLendablePercent, ..} ) <$> f v1ExemptPriorityLevelConfigurationLendablePercent
...
v1ExemptPriorityLevelConfigurationNominalConcurrencySharesL f V1ExemptPriorityLevelConfiguration{..} = (\v1ExemptPriorityLevelConfigurationNominalConcurrencyShares -> V1ExemptPriorityLevelConfiguration { v1ExemptPriorityLevelConfigurationNominalConcurrencyShares, ..} ) <$> f v1ExemptPriorityLevelConfigurationNominalConcurrencyShares
...
v1ExpressionWarningFieldRefL f V1ExpressionWarning{..} = (\v1ExpressionWarningFieldRef -> V1ExpressionWarning { v1ExpressionWarningFieldRef, ..} ) <$> f v1ExpressionWarningFieldRef
...
v1ExpressionWarningWarningL f V1ExpressionWarning{..} = (\v1ExpressionWarningWarning -> V1ExpressionWarning { v1ExpressionWarningWarning, ..} ) <$> f v1ExpressionWarningWarning
...
v1FlowDistinguisherMethodTypeL f V1FlowDistinguisherMethod{..} = (\v1FlowDistinguisherMethodType -> V1FlowDistinguisherMethod { v1FlowDistinguisherMethodType, ..} ) <$> f v1FlowDistinguisherMethodType
...
v1FlowSchemaApiVersionL f V1FlowSchema{..} = (\v1FlowSchemaApiVersion -> V1FlowSchema { v1FlowSchemaApiVersion, ..} ) <$> f v1FlowSchemaApiVersion
{-# INLINE v1FlowSchemaApiVersionL #-}

-- | 'v1FlowSchemaKind' Lens
v1FlowSchemaKindL :: Lens_' V1FlowSchema (Maybe Text)
v1FlowSchemaKindL f V1FlowSchema{..} = (\v1FlowSchemaKind -> V1FlowSchema { v1FlowSchemaKind, ..} ) <$> f v1FlowSchemaKind
{-# INLINE v1FlowSchemaKindL #-}

-- | 'v1FlowSchemaMetadata' Lens
v1FlowSchemaMetadataL :: Lens_' V1FlowSchema (Maybe V1ObjectMeta)
v1FlowSchemaMetadataL f V1FlowSchema{..} = (\v1FlowSchemaMetadata -> V1FlowSchema { v1FlowSchemaMetadata, ..} ) <$> f v1FlowSchemaMetadata
{-# INLINE v1FlowSchemaMetadataL #-}

-- | 'v1FlowSchemaSpec' Lens
v1FlowSchemaSpecL :: Lens_' V1FlowSchema (Maybe V1FlowSchemaSpec)
v1FlowSchemaSpecL f V1FlowSchema{..} = (\v1FlowSchemaSpec -> V1FlowSchema { v1FlowSchemaSpec, ..} ) <$> f v1FlowSchemaSpec
{-# INLINE v1FlowSchemaSpecL #-}

-- | 'v1FlowSchemaStatus' Lens
v1FlowSchemaStatusL :: Lens_' V1FlowSchema (Maybe V1FlowSchemaStatus)
v1FlowSchemaStatusL f V1FlowSchema{..} = (\v1FlowSchemaStatus -> V1FlowSchema { v1FlowSchemaStatus, ..} ) <$> f v1FlowSchemaStatus
...
v1FlowSchemaConditionLastTransitionTimeL f V1FlowSchemaCondition{..} = (\v1FlowSchemaConditionLastTransitionTime -> V1FlowSchemaCondition { v1FlowSchemaConditionLastTransitionTime, ..} ) <$> f v1FlowSchemaConditionLastTransitionTime
...
v1FlowSchemaConditionMessageL f V1FlowSchemaCondition{..} = (\v1FlowSchemaConditionMessage -> V1FlowSchemaCondition { v1FlowSchemaConditionMessage, ..} ) <$> f v1FlowSchemaConditionMessage
...
v1FlowSchemaConditionReasonL f V1FlowSchemaCondition{..} = (\v1FlowSchemaConditionReason -> V1FlowSchemaCondition { v1FlowSchemaConditionReason, ..} ) <$> f v1FlowSchemaConditionReason
...
v1FlowSchemaConditionStatusL f V1FlowSchemaCondition{..} = (\v1FlowSchemaConditionStatus -> V1FlowSchemaCondition { v1FlowSchemaConditionStatus, ..} ) <$> f v1FlowSchemaConditionStatus
...
v1FlowSchemaConditionTypeL f V1FlowSchemaCondition{..} = (\v1FlowSchemaConditionType -> V1FlowSchemaCondition { v1FlowSchemaConditionType, ..} ) <$> f v1FlowSchemaConditionType
...
v1FlowSchemaListApiVersionL f V1FlowSchemaList{..} = (\v1FlowSchemaListApiVersion -> V1FlowSchemaList { v1FlowSchemaListApiVersion, ..} ) <$> f v1FlowSchemaListApiVersion
{-# INLINE v1FlowSchemaListApiVersionL #-}

-- | 'v1FlowSchemaListItems' Lens
v1FlowSchemaListItemsL :: Lens_' V1FlowSchemaList ([V1FlowSchema])
v1FlowSchemaListItemsL f V1FlowSchemaList{..} = (\v1FlowSchemaListItems -> V1FlowSchemaList { v1FlowSchemaListItems, ..} ) <$> f v1FlowSchemaListItems
{-# INLINE v1FlowSchemaListItemsL #-}

-- | 'v1FlowSchemaListKind' Lens
v1FlowSchemaListKindL :: Lens_' V1FlowSchemaList (Maybe Text)
v1FlowSchemaListKindL f V1FlowSchemaList{..} = (\v1FlowSchemaListKind -> V1FlowSchemaList { v1FlowSchemaListKind, ..} ) <$> f v1FlowSchemaListKind
...
v1FlowSchemaListMetadataL f V1FlowSchemaList{..} = (\v1FlowSchemaListMetadata -> V1FlowSchemaList { v1FlowSchemaListMetadata, ..} ) <$> f v1FlowSchemaListMetadata
...
v1FlowSchemaSpecDistinguisherMethodL f V1FlowSchemaSpec{..} = (\v1FlowSchemaSpecDistinguisherMethod -> V1FlowSchemaSpec { v1FlowSchemaSpecDistinguisherMethod, ..} ) <$> f v1FlowSchemaSpecDistinguisherMethod
...
v1FlowSchemaSpecMatchingPrecedenceL f V1FlowSchemaSpec{..} = (\v1FlowSchemaSpecMatchingPrecedence -> V1FlowSchemaSpec { v1FlowSchemaSpecMatchingPrecedence, ..} ) <$> f v1FlowSchemaSpecMatchingPrecedence
...
v1FlowSchemaSpecPriorityLevelConfigurationL f V1FlowSchemaSpec{..} = (\v1FlowSchemaSpecPriorityLevelConfiguration -> V1FlowSchemaSpec { v1FlowSchemaSpecPriorityLevelConfiguration, ..} ) <$> f v1FlowSchemaSpecPriorityLevelConfiguration
...
v1FlowSchemaSpecRulesL f V1FlowSchemaSpec{..} = (\v1FlowSchemaSpecRules -> V1FlowSchemaSpec { v1FlowSchemaSpecRules, ..} ) <$> f v1FlowSchemaSpecRules
...
v1FlowSchemaStatusConditionsL f V1FlowSchemaStatus{..} = (\v1FlowSchemaStatusConditions -> V1FlowSchemaStatus { v1FlowSchemaStatusConditions, ..} ) <$> f v1FlowSchemaStatusConditions
...
v1GroupSubjectNameL f V1GroupSubject{..} = (\v1GroupSubjectName -> V1GroupSubject { v1GroupSubjectName, ..} ) <$> f v1GroupSubjectName
...
v1JobSpecManagedByL f V1JobSpec{..} = (\v1JobSpecManagedBy -> V1JobSpec { v1JobSpecManagedBy, ..} ) <$> f v1JobSpecManagedBy
...
v1JobSpecSuccessPolicyL f V1JobSpec{..} = (\v1JobSpecSuccessPolicy -> V1JobSpec { v1JobSpecSuccessPolicy, ..} ) <$> f v1JobSpecSuccessPolicy
...
v1LifecycleHandlerSleepL f V1LifecycleHandler{..} = (\v1LifecycleHandlerSleep -> V1LifecycleHandler { v1LifecycleHandlerSleep, ..} ) <$> f v1LifecycleHandlerSleep
...
v1LimitResponseQueuingL f V1LimitResponse{..} = (\v1LimitResponseQueuing -> V1LimitResponse { v1LimitResponseQueuing, ..} ) <$> f v1LimitResponseQueuing
{-# INLINE v1LimitResponseQueuingL #-}

-- | 'v1LimitResponseType' Lens
v1LimitResponseTypeL :: Lens_' V1LimitResponse (Text)
v1LimitResponseTypeL f V1LimitResponse{..} = (\v1LimitResponseType -> V1LimitResponse { v1LimitResponseType, ..} ) <$> f v1LimitResponseType
...
v1LimitedPriorityLevelConfigurationBorrowingLimitPercentL f V1LimitedPriorityLevelConfiguration{..} = (\v1LimitedPriorityLevelConfigurationBorrowingLimitPercent -> V1LimitedPriorityLevelConfiguration { v1LimitedPriorityLevelConfigurationBorrowingLimitPercent, ..} ) <$> f v1LimitedPriorityLevelConfigurationBorrowingLimitPercent
...
v1LimitedPriorityLevelConfigurationLendablePercentL f V1LimitedPriorityLevelConfiguration{..} = (\v1LimitedPriorityLevelConfigurationLendablePercent -> V1LimitedPriorityLevelConfiguration { v1LimitedPriorityLevelConfigurationLendablePercent, ..} ) <$> f v1LimitedPriorityLevelConfigurationLendablePercent
...
v1LimitedPriorityLevelConfigurationLimitResponseL f V1LimitedPriorityLevelConfiguration{..} = (\v1LimitedPriorityLevelConfigurationLimitResponse -> V1LimitedPriorityLevelConfiguration { v1LimitedPriorityLevelConfigurationLimitResponse, ..} ) <$> f v1LimitedPriorityLevelConfigurationLimitResponse
...
v1LimitedPriorityLevelConfigurationNominalConcurrencySharesL f V1LimitedPriorityLevelConfiguration{..} = (\v1LimitedPriorityLevelConfigurationNominalConcurrencyShares -> V1LimitedPriorityLevelConfiguration { v1LimitedPriorityLevelConfigurationNominalConcurrencyShares, ..} ) <$> f v1LimitedPriorityLevelConfigurationNominalConcurrencyShares
...
v1LoadBalancerIngressIpModeL f V1LoadBalancerIngress{..} = (\v1LoadBalancerIngressIpMode -> V1LoadBalancerIngress { v1LoadBalancerIngressIpMode, ..} ) <$> f v1LoadBalancerIngressIpMode
...
v1MatchResourcesExcludeResourceRulesL f V1MatchResources{..} = (\v1MatchResourcesExcludeResourceRules -> V1MatchResources { v1MatchResourcesExcludeResourceRules, ..} ) <$> f v1MatchResourcesExcludeResourceRules
...
v1MatchResourcesMatchPolicyL f V1MatchResources{..} = (\v1MatchResourcesMatchPolicy -> V1MatchResources { v1MatchResourcesMatchPolicy, ..} ) <$> f v1MatchResourcesMatchPolicy
...
v1MatchResourcesNamespaceSelectorL f V1MatchResources{..} = (\v1MatchResourcesNamespaceSelector -> V1MatchResources { v1MatchResourcesNamespaceSelector, ..} ) <$> f v1MatchResourcesNamespaceSelector
...
v1MatchResourcesObjectSelectorL f V1MatchResources{..} = (\v1MatchResourcesObjectSelector -> V1MatchResources { v1MatchResourcesObjectSelector, ..} ) <$> f v1MatchResourcesObjectSelector
...
v1MatchResourcesResourceRulesL f V1MatchResources{..} = (\v1MatchResourcesResourceRules -> V1MatchResources { v1MatchResourcesResourceRules, ..} ) <$> f v1MatchResourcesResourceRules
...
v1ModifyVolumeStatusStatusL f V1ModifyVolumeStatus{..} = (\v1ModifyVolumeStatusStatus -> V1ModifyVolumeStatus { v1ModifyVolumeStatusStatus, ..} ) <$> f v1ModifyVolumeStatusStatus
...
v1ModifyVolumeStatusTargetVolumeAttributesClassNameL f V1ModifyVolumeStatus{..} = (\v1ModifyVolumeStatusTargetVolumeAttributesClassName -> V1ModifyVolumeStatus { v1ModifyVolumeStatusTargetVolumeAttributesClassName, ..} ) <$> f v1ModifyVolumeStatusTargetVolumeAttributesClassName
...
v1NamedRuleWithOperationsApiGroupsL f V1NamedRuleWithOperations{..} = (\v1NamedRuleWithOperationsApiGroups -> V1NamedRuleWithOperations { v1NamedRuleWithOperationsApiGroups, ..} ) <$> f v1NamedRuleWithOperationsApiGroups
...
v1NamedRuleWithOperationsApiVersionsL f V1NamedRuleWithOperations{..} = (\v1NamedRuleWithOperationsApiVersions -> V1NamedRuleWithOperations { v1NamedRuleWithOperationsApiVersions, ..} ) <$> f v1NamedRuleWithOperationsApiVersions
...
v1NamedRuleWithOperationsOperationsL f V1NamedRuleWithOperations{..} = (\v1NamedRuleWithOperationsOperations -> V1NamedRuleWithOperations { v1NamedRuleWithOperationsOperations, ..} ) <$> f v1NamedRuleWithOperationsOperations
...
v1NamedRuleWithOperationsResourceNamesL f V1NamedRuleWithOperations{..} = (\v1NamedRuleWithOperationsResourceNames -> V1NamedRuleWithOperations { v1NamedRuleWithOperationsResourceNames, ..} ) <$> f v1NamedRuleWithOperationsResourceNames
...
v1NamedRuleWithOperationsResourcesL f V1NamedRuleWithOperations{..} = (\v1NamedRuleWithOperationsResources -> V1NamedRuleWithOperations { v1NamedRuleWithOperationsResources, ..} ) <$> f v1NamedRuleWithOperationsResources
...
v1NamedRuleWithOperationsScopeL f V1NamedRuleWithOperations{..} = (\v1NamedRuleWithOperationsScope -> V1NamedRuleWithOperations { v1NamedRuleWithOperationsScope, ..} ) <$> f v1NamedRuleWithOperationsScope
...
v1NodeRuntimeHandlerFeaturesL f V1NodeRuntimeHandler{..} = (\v1NodeRuntimeHandlerFeatures -> V1NodeRuntimeHandler { v1NodeRuntimeHandlerFeatures, ..} ) <$> f v1NodeRuntimeHandlerFeatures
...
v1NodeRuntimeHandlerNameL f V1NodeRuntimeHandler{..} = (\v1NodeRuntimeHandlerName -> V1NodeRuntimeHandler { v1NodeRuntimeHandlerName, ..} ) <$> f v1NodeRuntimeHandlerName
...
v1NodeRuntimeHandlerFeaturesRecursiveReadOnlyMountsL f V1NodeRuntimeHandlerFeatures{..} = (\v1NodeRuntimeHandlerFeaturesRecursiveReadOnlyMounts -> V1NodeRuntimeHandlerFeatures { v1NodeRuntimeHandlerFeaturesRecursiveReadOnlyMounts, ..} ) <$> f v1NodeRuntimeHandlerFeaturesRecursiveReadOnlyMounts
...
v1NodeStatusRuntimeHandlersL f V1NodeStatus{..} = (\v1NodeStatusRuntimeHandlers -> V1NodeStatus { v1NodeStatusRuntimeHandlers, ..} ) <$> f v1NodeStatusRuntimeHandlers
...
v1NonResourcePolicyRuleNonResourceUrlsL f V1NonResourcePolicyRule{..} = (\v1NonResourcePolicyRuleNonResourceUrls -> V1NonResourcePolicyRule { v1NonResourcePolicyRuleNonResourceUrls, ..} ) <$> f v1NonResourcePolicyRuleNonResourceUrls
...
v1NonResourcePolicyRuleVerbsL f V1NonResourcePolicyRule{..} = (\v1NonResourcePolicyRuleVerbs -> V1NonResourcePolicyRule { v1NonResourcePolicyRuleVerbs, ..} ) <$> f v1NonResourcePolicyRuleVerbs
...
v1ParamKindApiVersionL f V1ParamKind{..} = (\v1ParamKindApiVersion -> V1ParamKind { v1ParamKindApiVersion, ..} ) <$> f v1ParamKindApiVersion
{-# INLINE v1ParamKindApiVersionL #-}

-- | 'v1ParamKindKind' Lens
v1ParamKindKindL :: Lens_' V1ParamKind (Maybe Text)
v1ParamKindKindL f V1ParamKind{..} = (\v1ParamKindKind -> V1ParamKind { v1ParamKindKind, ..} ) <$> f v1ParamKindKind
...
v1ParamRefNameL f V1ParamRef{..} = (\v1ParamRefName -> V1ParamRef { v1ParamRefName, ..} ) <$> f v1ParamRefName
{-# INLINE v1ParamRefNameL #-}

-- | 'v1ParamRefNamespace' Lens
v1ParamRefNamespaceL :: Lens_' V1ParamRef (Maybe Text)
v1ParamRefNamespaceL f V1ParamRef{..} = (\v1ParamRefNamespace -> V1ParamRef { v1ParamRefNamespace, ..} ) <$> f v1ParamRefNamespace
...
v1ParamRefParameterNotFoundActionL f V1ParamRef{..} = (\v1ParamRefParameterNotFoundAction -> V1ParamRef { v1ParamRefParameterNotFoundAction, ..} ) <$> f v1ParamRefParameterNotFoundAction
...
v1ParamRefSelectorL f V1ParamRef{..} = (\v1ParamRefSelector -> V1ParamRef { v1ParamRefSelector, ..} ) <$> f v1ParamRefSelector
...
v1PersistentVolumeClaimSpecVolumeAttributesClassNameL f V1PersistentVolumeClaimSpec{..} = (\v1PersistentVolumeClaimSpecVolumeAttributesClassName -> V1PersistentVolumeClaimSpec { v1PersistentVolumeClaimSpecVolumeAttributesClassName, ..} ) <$> f v1PersistentVolumeClaimSpecVolumeAttributesClassName
...
v1PersistentVolumeClaimStatusCurrentVolumeAttributesClassNameL f V1PersistentVolumeClaimStatus{..} = (\v1PersistentVolumeClaimStatusCurrentVolumeAttributesClassName -> V1PersistentVolumeClaimStatus { v1PersistentVolumeClaimStatusCurrentVolumeAttributesClassName, ..} ) <$> f v1PersistentVolumeClaimStatusCurrentVolumeAttributesClassName
...
v1PersistentVolumeClaimStatusModifyVolumeStatusL f V1PersistentVolumeClaimStatus{..} = (\v1PersistentVolumeClaimStatusModifyVolumeStatus -> V1PersistentVolumeClaimStatus { v1PersistentVolumeClaimStatusModifyVolumeStatus, ..} ) <$> f v1PersistentVolumeClaimStatusModifyVolumeStatus
...
v1PersistentVolumeSpecVolumeAttributesClassNameL f V1PersistentVolumeSpec{..} = (\v1PersistentVolumeSpecVolumeAttributesClassName -> V1PersistentVolumeSpec { v1PersistentVolumeSpecVolumeAttributesClassName, ..} ) <$> f v1PersistentVolumeSpecVolumeAttributesClassName
...
v1PodAffinityTermMatchLabelKeysL f V1PodAffinityTerm{..} = (\v1PodAffinityTermMatchLabelKeys -> V1PodAffinityTerm { v1PodAffinityTermMatchLabelKeys, ..} ) <$> f v1PodAffinityTermMatchLabelKeys
...
v1PodAffinityTermMismatchLabelKeysL f V1PodAffinityTerm{..} = (\v1PodAffinityTermMismatchLabelKeys -> V1PodAffinityTerm { v1PodAffinityTermMismatchLabelKeys, ..} ) <$> f v1PodAffinityTermMismatchLabelKeys
...
v1PodSecurityContextAppArmorProfileL f V1PodSecurityContext{..} = (\v1PodSecurityContextAppArmorProfile -> V1PodSecurityContext { v1PodSecurityContextAppArmorProfile, ..} ) <$> f v1PodSecurityContextAppArmorProfile
...
v1PolicyRulesWithSubjectsNonResourceRulesL f V1PolicyRulesWithSubjects{..} = (\v1PolicyRulesWithSubjectsNonResourceRules -> V1PolicyRulesWithSubjects { v1PolicyRulesWithSubjectsNonResourceRules, ..} ) <$> f v1PolicyRulesWithSubjectsNonResourceRules
...
v1PolicyRulesWithSubjectsResourceRulesL f V1PolicyRulesWithSubjects{..} = (\v1PolicyRulesWithSubjectsResourceRules -> V1PolicyRulesWithSubjects { v1PolicyRulesWithSubjectsResourceRules, ..} ) <$> f v1PolicyRulesWithSubjectsResourceRules
...
v1PolicyRulesWithSubjectsSubjectsL f V1PolicyRulesWithSubjects{..} = (\v1PolicyRulesWithSubjectsSubjects -> V1PolicyRulesWithSubjects { v1PolicyRulesWithSubjectsSubjects, ..} ) <$> f v1PolicyRulesWithSubjectsSubjects
...
v1PriorityLevelConfigurationApiVersionL f V1PriorityLevelConfiguration{..} = (\v1PriorityLevelConfigurationApiVersion -> V1PriorityLevelConfiguration { v1PriorityLevelConfigurationApiVersion, ..} ) <$> f v1PriorityLevelConfigurationApiVersion
...
v1PriorityLevelConfigurationKindL f V1PriorityLevelConfiguration{..} = (\v1PriorityLevelConfigurationKind -> V1PriorityLevelConfiguration { v1PriorityLevelConfigurationKind, ..} ) <$> f v1PriorityLevelConfigurationKind
...
v1PriorityLevelConfigurationMetadataL f V1PriorityLevelConfiguration{..} = (\v1PriorityLevelConfigurationMetadata -> V1PriorityLevelConfiguration { v1PriorityLevelConfigurationMetadata, ..} ) <$> f v1PriorityLevelConfigurationMetadata
...
v1PriorityLevelConfigurationSpecL f V1PriorityLevelConfiguration{..} = (\v1PriorityLevelConfigurationSpec -> V1PriorityLevelConfiguration { v1PriorityLevelConfigurationSpec, ..} ) <$> f v1PriorityLevelConfigurationSpec
...
v1PriorityLevelConfigurationStatusL f V1PriorityLevelConfiguration{..} = (\v1PriorityLevelConfigurationStatus -> V1PriorityLevelConfiguration { v1PriorityLevelConfigurationStatus, ..} ) <$> f v1PriorityLevelConfigurationStatus
...
v1PriorityLevelConfigurationConditionLastTransitionTimeL f V1PriorityLevelConfigurationCondition{..} = (\v1PriorityLevelConfigurationConditionLastTransitionTime -> V1PriorityLevelConfigurationCondition { v1PriorityLevelConfigurationConditionLastTransitionTime, ..} ) <$> f v1PriorityLevelConfigurationConditionLastTransitionTime
...
v1PriorityLevelConfigurationConditionMessageL f V1PriorityLevelConfigurationCondition{..} = (\v1PriorityLevelConfigurationConditionMessage -> V1PriorityLevelConfigurationCondition { v1PriorityLevelConfigurationConditionMessage, ..} ) <$> f v1PriorityLevelConfigurationConditionMessage
...
v1PriorityLevelConfigurationConditionReasonL f V1PriorityLevelConfigurationCondition{..} = (\v1PriorityLevelConfigurationConditionReason -> V1PriorityLevelConfigurationCondition { v1PriorityLevelConfigurationConditionReason, ..} ) <$> f v1PriorityLevelConfigurationConditionReason
...
v1PriorityLevelConfigurationConditionStatusL f V1PriorityLevelConfigurationCondition{..} = (\v1PriorityLevelConfigurationConditionStatus -> V1PriorityLevelConfigurationCondition { v1PriorityLevelConfigurationConditionStatus, ..} ) <$> f v1PriorityLevelConfigurationConditionStatus
...
v1PriorityLevelConfigurationConditionTypeL f V1PriorityLevelConfigurationCondition{..} = (\v1PriorityLevelConfigurationConditionType -> V1PriorityLevelConfigurationCondition { v1PriorityLevelConfigurationConditionType, ..} ) <$> f v1PriorityLevelConfigurationConditionType
...
v1PriorityLevelConfigurationListApiVersionL f V1PriorityLevelConfigurationList{..} = (\v1PriorityLevelConfigurationListApiVersion -> V1PriorityLevelConfigurationList { v1PriorityLevelConfigurationListApiVersion, ..} ) <$> f v1PriorityLevelConfigurationListApiVersion
...
v1PriorityLevelConfigurationListItemsL f V1PriorityLevelConfigurationList{..} = (\v1PriorityLevelConfigurationListItems -> V1PriorityLevelConfigurationList { v1PriorityLevelConfigurationListItems, ..} ) <$> f v1PriorityLevelConfigurationListItems
...
v1PriorityLevelConfigurationListKindL f V1PriorityLevelConfigurationList{..} = (\v1PriorityLevelConfigurationListKind -> V1PriorityLevelConfigurationList { v1PriorityLevelConfigurationListKind, ..} ) <$> f v1PriorityLevelConfigurationListKind
...
v1PriorityLevelConfigurationListMetadataL f V1PriorityLevelConfigurationList{..} = (\v1PriorityLevelConfigurationListMetadata -> V1PriorityLevelConfigurationList { v1PriorityLevelConfigurationListMetadata, ..} ) <$> f v1PriorityLevelConfigurationListMetadata
...
v1PriorityLevelConfigurationReferenceNameL f V1PriorityLevelConfigurationReference{..} = (\v1PriorityLevelConfigurationReferenceName -> V1PriorityLevelConfigurationReference { v1PriorityLevelConfigurationReferenceName, ..} ) <$> f v1PriorityLevelConfigurationReferenceName
...
v1PriorityLevelConfigurationSpecExemptL f V1PriorityLevelConfigurationSpec{..} = (\v1PriorityLevelConfigurationSpecExempt -> V1PriorityLevelConfigurationSpec { v1PriorityLevelConfigurationSpecExempt, ..} ) <$> f v1PriorityLevelConfigurationSpecExempt
...
v1PriorityLevelConfigurationSpecLimitedL f V1PriorityLevelConfigurationSpec{..} = (\v1PriorityLevelConfigurationSpecLimited -> V1PriorityLevelConfigurationSpec { v1PriorityLevelConfigurationSpecLimited, ..} ) <$> f v1PriorityLevelConfigurationSpecLimited
...
v1PriorityLevelConfigurationSpecTypeL f V1PriorityLevelConfigurationSpec{..} = (\v1PriorityLevelConfigurationSpecType -> V1PriorityLevelConfigurationSpec { v1PriorityLevelConfigurationSpecType, ..} ) <$> f v1PriorityLevelConfigurationSpecType
...
v1PriorityLevelConfigurationStatusConditionsL f V1PriorityLevelConfigurationStatus{..} = (\v1PriorityLevelConfigurationStatusConditions -> V1PriorityLevelConfigurationStatus { v1PriorityLevelConfigurationStatusConditions, ..} ) <$> f v1PriorityLevelConfigurationStatusConditions
...
v1QueuingConfigurationHandSizeL f V1QueuingConfiguration{..} = (\v1QueuingConfigurationHandSize -> V1QueuingConfiguration { v1QueuingConfigurationHandSize, ..} ) <$> f v1QueuingConfigurationHandSize
...
v1QueuingConfigurationQueueLengthLimitL f V1QueuingConfiguration{..} = (\v1QueuingConfigurationQueueLengthLimit -> V1QueuingConfiguration { v1QueuingConfigurationQueueLengthLimit, ..} ) <$> f v1QueuingConfigurationQueueLengthLimit
...
v1QueuingConfigurationQueuesL f V1QueuingConfiguration{..} = (\v1QueuingConfigurationQueues -> V1QueuingConfiguration { v1QueuingConfigurationQueues, ..} ) <$> f v1QueuingConfigurationQueues
...
v1ResourcePolicyRuleApiGroupsL f V1ResourcePolicyRule{..} = (\v1ResourcePolicyRuleApiGroups -> V1ResourcePolicyRule { v1ResourcePolicyRuleApiGroups, ..} ) <$> f v1ResourcePolicyRuleApiGroups
...
v1ResourcePolicyRuleClusterScopeL f V1ResourcePolicyRule{..} = (\v1ResourcePolicyRuleClusterScope -> V1ResourcePolicyRule { v1ResourcePolicyRuleClusterScope, ..} ) <$> f v1ResourcePolicyRuleClusterScope
...
v1ResourcePolicyRuleNamespacesL f V1ResourcePolicyRule{..} = (\v1ResourcePolicyRuleNamespaces -> V1ResourcePolicyRule { v1ResourcePolicyRuleNamespaces, ..} ) <$> f v1ResourcePolicyRuleNamespaces
...
v1ResourcePolicyRuleResourcesL f V1ResourcePolicyRule{..} = (\v1ResourcePolicyRuleResources -> V1ResourcePolicyRule { v1ResourcePolicyRuleResources, ..} ) <$> f v1ResourcePolicyRuleResources
...
v1ResourcePolicyRuleVerbsL f V1ResourcePolicyRule{..} = (\v1ResourcePolicyRuleVerbs -> V1ResourcePolicyRule { v1ResourcePolicyRuleVerbs, ..} ) <$> f v1ResourcePolicyRuleVerbs
...
v1SecurityContextAppArmorProfileL f V1SecurityContext{..} = (\v1SecurityContextAppArmorProfile -> V1SecurityContext { v1SecurityContextAppArmorProfile, ..} ) <$> f v1SecurityContextAppArmorProfile
...
v1SelectableFieldJsonPathL f V1SelectableField{..} = (\v1SelectableFieldJsonPath -> V1SelectableField { v1SelectableFieldJsonPath, ..} ) <$> f v1SelectableFieldJsonPath
...
v1ServiceAccountSubjectNameL f V1ServiceAccountSubject{..} = (\v1ServiceAccountSubjectName -> V1ServiceAccountSubject { v1ServiceAccountSubjectName, ..} ) <$> f v1ServiceAccountSubjectName
...
v1ServiceAccountSubjectNamespaceL f V1ServiceAccountSubject{..} = (\v1ServiceAccountSubjectNamespace -> V1ServiceAccountSubject { v1ServiceAccountSubjectNamespace, ..} ) <$> f v1ServiceAccountSubjectNamespace
...
v1ServiceSpecTrafficDistributionL f V1ServiceSpec{..} = (\v1ServiceSpecTrafficDistribution -> V1ServiceSpec { v1ServiceSpecTrafficDistribution, ..} ) <$> f v1ServiceSpecTrafficDistribution
...
v1SleepActionSecondsL f V1SleepAction{..} = (\v1SleepActionSeconds -> V1SleepAction { v1SleepActionSeconds, ..} ) <$> f v1SleepActionSeconds
...
v1SuccessPolicyRulesL f V1SuccessPolicy{..} = (\v1SuccessPolicyRules -> V1SuccessPolicy { v1SuccessPolicyRules, ..} ) <$> f v1SuccessPolicyRules
...
v1SuccessPolicyRuleSucceededCountL f V1SuccessPolicyRule{..} = (\v1SuccessPolicyRuleSucceededCount -> V1SuccessPolicyRule { v1SuccessPolicyRuleSucceededCount, ..} ) <$> f v1SuccessPolicyRuleSucceededCount
...
v1SuccessPolicyRuleSucceededIndexesL f V1SuccessPolicyRule{..} = (\v1SuccessPolicyRuleSucceededIndexes -> V1SuccessPolicyRule { v1SuccessPolicyRuleSucceededIndexes, ..} ) <$> f v1SuccessPolicyRuleSucceededIndexes
...
v1TypeCheckingExpressionWarningsL f V1TypeChecking{..} = (\v1TypeCheckingExpressionWarnings -> V1TypeChecking { v1TypeCheckingExpressionWarnings, ..} ) <$> f v1TypeCheckingExpressionWarnings
...
v1UserSubjectNameL f V1UserSubject{..} = (\v1UserSubjectName -> V1UserSubject { v1UserSubjectName, ..} ) <$> f v1UserSubjectName
...
v1ValidatingAdmissionPolicyApiVersionL f V1ValidatingAdmissionPolicy{..} = (\v1ValidatingAdmissionPolicyApiVersion -> V1ValidatingAdmissionPolicy { v1ValidatingAdmissionPolicyApiVersion, ..} ) <$> f v1ValidatingAdmissionPolicyApiVersion
...
v1ValidatingAdmissionPolicyKindL f V1ValidatingAdmissionPolicy{..} = (\v1ValidatingAdmissionPolicyKind -> V1ValidatingAdmissionPolicy { v1ValidatingAdmissionPolicyKind, ..} ) <$> f v1ValidatingAdmissionPolicyKind
...
v1ValidatingAdmissionPolicyMetadataL f V1ValidatingAdmissionPolicy{..} = (\v1ValidatingAdmissionPolicyMetadata -> V1ValidatingAdmissionPolicy { v1ValidatingAdmissionPolicyMetadata, ..} ) <$> f v1ValidatingAdmissionPolicyMetadata
...
v1ValidatingAdmissionPolicySpecL f V1ValidatingAdmissionPolicy{..} = (\v1ValidatingAdmissionPolicySpec -> V1ValidatingAdmissionPolicy { v1ValidatingAdmissionPolicySpec, ..} ) <$> f v1ValidatingAdmissionPolicySpec
...
v1ValidatingAdmissionPolicyStatusL f V1ValidatingAdmissionPolicy{..} = (\v1ValidatingAdmissionPolicyStatus -> V1ValidatingAdmissionPolicy { v1ValidatingAdmissionPolicyStatus, ..} ) <$> f v1ValidatingAdmissionPolicyStatus
...
v1ValidatingAdmissionPolicyBindingApiVersionL f V1ValidatingAdmissionPolicyBinding{..} = (\v1ValidatingAdmissionPolicyBindingApiVersion -> V1ValidatingAdmissionPolicyBinding { v1ValidatingAdmissionPolicyBindingApiVersion, ..} ) <$> f v1ValidatingAdmissionPolicyBindingApiVersion
...
v1ValidatingAdmissionPolicyBindingKindL f V1ValidatingAdmissionPolicyBinding{..} = (\v1ValidatingAdmissionPolicyBindingKind -> V1ValidatingAdmissionPolicyBinding { v1ValidatingAdmissionPolicyBindingKind, ..} ) <$> f v1ValidatingAdmissionPolicyBindingKind
...
v1ValidatingAdmissionPolicyBindingMetadataL f V1ValidatingAdmissionPolicyBinding{..} = (\v1ValidatingAdmissionPolicyBindingMetadata -> V1ValidatingAdmissionPolicyBinding { v1ValidatingAdmissionPolicyBindingMetadata, ..} ) <$> f v1ValidatingAdmissionPolicyBindingMetadata
...
v1ValidatingAdmissionPolicyBindingSpecL f V1ValidatingAdmissionPolicyBinding{..} = (\v1ValidatingAdmissionPolicyBindingSpec -> V1ValidatingAdmissionPolicyBinding { v1ValidatingAdmissionPolicyBindingSpec, ..} ) <$> f v1ValidatingAdmissionPolicyBindingSpec
...
v1ValidatingAdmissionPolicyBindingListApiVersionL f V1ValidatingAdmissionPolicyBindingList{..} = (\v1ValidatingAdmissionPolicyBindingListApiVersion -> V1ValidatingAdmissionPolicyBindingList { v1ValidatingAdmissionPolicyBindingListApiVersion, ..} ) <$> f v1ValidatingAdmissionPolicyBindingListApiVersion
...
v1ValidatingAdmissionPolicyBindingListItemsL f V1ValidatingAdmissionPolicyBindingList{..} = (\v1ValidatingAdmissionPolicyBindingListItems -> V1ValidatingAdmissionPolicyBindingList { v1ValidatingAdmissionPolicyBindingListItems, ..} ) <$> f v1ValidatingAdmissionPolicyBindingListItems
...
v1ValidatingAdmissionPolicyBindingListKindL f V1ValidatingAdmissionPolicyBindingList{..} = (\v1ValidatingAdmissionPolicyBindingListKind -> V1ValidatingAdmissionPolicyBindingList { v1ValidatingAdmissionPolicyBindingListKind, ..} ) <$> f v1ValidatingAdmissionPolicyBindingListKind
...
v1ValidatingAdmissionPolicyBindingListMetadataL f V1ValidatingAdmissionPolicyBindingList{..} = (\v1ValidatingAdmissionPolicyBindingListMetadata -> V1ValidatingAdmissionPolicyBindingList { v1ValidatingAdmissionPolicyBindingListMetadata, ..} ) <$> f v1ValidatingAdmissionPolicyBindingListMetadata
...
v1ValidatingAdmissionPolicyBindingSpecMatchResourcesL f V1ValidatingAdmissionPolicyBindingSpec{..} = (\v1ValidatingAdmissionPolicyBindingSpecMatchResources -> V1ValidatingAdmissionPolicyBindingSpec { v1ValidatingAdmissionPolicyBindingSpecMatchResources, ..} ) <$> f v1ValidatingAdmissionPolicyBindingSpecMatchResources
...
v1ValidatingAdmissionPolicyBindingSpecParamRefL f V1ValidatingAdmissionPolicyBindingSpec{..} = (\v1ValidatingAdmissionPolicyBindingSpecParamRef -> V1ValidatingAdmissionPolicyBindingSpec { v1ValidatingAdmissionPolicyBindingSpecParamRef, ..} ) <$> f v1ValidatingAdmissionPolicyBindingSpecParamRef
...
v1ValidatingAdmissionPolicyBindingSpecPolicyNameL f V1ValidatingAdmissionPolicyBindingSpec{..} = (\v1ValidatingAdmissionPolicyBindingSpecPolicyName -> V1ValidatingAdmissionPolicyBindingSpec { v1ValidatingAdmissionPolicyBindingSpecPolicyName, ..} ) <$> f v1ValidatingAdmissionPolicyBindingSpecPolicyName
...
v1ValidatingAdmissionPolicyBindingSpecValidationActionsL f V1ValidatingAdmissionPolicyBindingSpec{..} = (\v1ValidatingAdmissionPolicyBindingSpecValidationActions -> V1ValidatingAdmissionPolicyBindingSpec { v1ValidatingAdmissionPolicyBindingSpecValidationActions, ..} ) <$> f v1ValidatingAdmissionPolicyBindingSpecValidationActions
...
v1ValidatingAdmissionPolicyListApiVersionL f V1ValidatingAdmissionPolicyList{..} = (\v1ValidatingAdmissionPolicyListApiVersion -> V1ValidatingAdmissionPolicyList { v1ValidatingAdmissionPolicyListApiVersion, ..} ) <$> f v1ValidatingAdmissionPolicyListApiVersion
...
v1ValidatingAdmissionPolicyListItemsL f V1ValidatingAdmissionPolicyList{..} = (\v1ValidatingAdmissionPolicyListItems -> V1ValidatingAdmissionPolicyList { v1ValidatingAdmissionPolicyListItems, ..} ) <$> f v1ValidatingAdmissionPolicyListItems
...
v1ValidatingAdmissionPolicyListKindL f V1ValidatingAdmissionPolicyList{..} = (\v1ValidatingAdmissionPolicyListKind -> V1ValidatingAdmissionPolicyList { v1ValidatingAdmissionPolicyListKind, ..} ) <$> f v1ValidatingAdmissionPolicyListKind
...
v1ValidatingAdmissionPolicyListMetadataL f V1ValidatingAdmissionPolicyList{..} = (\v1ValidatingAdmissionPolicyListMetadata -> V1ValidatingAdmissionPolicyList { v1ValidatingAdmissionPolicyListMetadata, ..} ) <$> f v1ValidatingAdmissionPolicyListMetadata
...
v1ValidatingAdmissionPolicySpecAuditAnnotationsL f V1ValidatingAdmissionPolicySpec{..} = (\v1ValidatingAdmissionPolicySpecAuditAnnotations -> V1ValidatingAdmissionPolicySpec { v1ValidatingAdmissionPolicySpecAuditAnnotations, ..} ) <$> f v1ValidatingAdmissionPolicySpecAuditAnnotations
...
v1ValidatingAdmissionPolicySpecFailurePolicyL f V1ValidatingAdmissionPolicySpec{..} = (\v1ValidatingAdmissionPolicySpecFailurePolicy -> V1ValidatingAdmissionPolicySpec { v1ValidatingAdmissionPolicySpecFailurePolicy, ..} ) <$> f v1ValidatingAdmissionPolicySpecFailurePolicy
...
v1ValidatingAdmissionPolicySpecMatchConditionsL f V1ValidatingAdmissionPolicySpec{..} = (\v1ValidatingAdmissionPolicySpecMatchConditions -> V1ValidatingAdmissionPolicySpec { v1ValidatingAdmissionPolicySpecMatchConditions, ..} ) <$> f v1ValidatingAdmissionPolicySpecMatchConditions
...
v1ValidatingAdmissionPolicySpecMatchConstraintsL f V1ValidatingAdmissionPolicySpec{..} = (\v1ValidatingAdmissionPolicySpecMatchConstraints -> V1ValidatingAdmissionPolicySpec { v1ValidatingAdmissionPolicySpecMatchConstraints, ..} ) <$> f v1ValidatingAdmissionPolicySpecMatchConstraints
...
v1ValidatingAdmissionPolicySpecParamKindL f V1ValidatingAdmissionPolicySpec{..} = (\v1ValidatingAdmissionPolicySpecParamKind -> V1ValidatingAdmissionPolicySpec { v1ValidatingAdmissionPolicySpecParamKind, ..} ) <$> f v1ValidatingAdmissionPolicySpecParamKind
...
v1ValidatingAdmissionPolicySpecValidationsL f V1ValidatingAdmissionPolicySpec{..} = (\v1ValidatingAdmissionPolicySpecValidations -> V1ValidatingAdmissionPolicySpec { v1ValidatingAdmissionPolicySpecValidations, ..} ) <$> f v1ValidatingAdmissionPolicySpecValidations
...
v1ValidatingAdmissionPolicySpecVariablesL f V1ValidatingAdmissionPolicySpec{..} = (\v1ValidatingAdmissionPolicySpecVariables -> V1ValidatingAdmissionPolicySpec { v1ValidatingAdmissionPolicySpecVariables, ..} ) <$> f v1ValidatingAdmissionPolicySpecVariables
...
v1ValidatingAdmissionPolicyStatusConditionsL f V1ValidatingAdmissionPolicyStatus{..} = (\v1ValidatingAdmissionPolicyStatusConditions -> V1ValidatingAdmissionPolicyStatus { v1ValidatingAdmissionPolicyStatusConditions, ..} ) <$> f v1ValidatingAdmissionPolicyStatusConditions
...
v1ValidatingAdmissionPolicyStatusObservedGenerationL f V1ValidatingAdmissionPolicyStatus{..} = (\v1ValidatingAdmissionPolicyStatusObservedGeneration -> V1ValidatingAdmissionPolicyStatus { v1ValidatingAdmissionPolicyStatusObservedGeneration, ..} ) <$> f v1ValidatingAdmissionPolicyStatusObservedGeneration
...
v1ValidatingAdmissionPolicyStatusTypeCheckingL f V1ValidatingAdmissionPolicyStatus{..} = (\v1ValidatingAdmissionPolicyStatusTypeChecking -> V1ValidatingAdmissionPolicyStatus { v1ValidatingAdmissionPolicyStatusTypeChecking, ..} ) <$> f v1ValidatingAdmissionPolicyStatusTypeChecking
...
v1ValidationExpressionL f V1Validation{..} = (\v1ValidationExpression -> V1Validation { v1ValidationExpression, ..} ) <$> f v1ValidationExpression
{-# INLINE v1ValidationExpressionL #-}

-- | 'v1ValidationMessage' Lens
v1ValidationMessageL :: Lens_' V1Validation (Maybe Text)
v1ValidationMessageL f V1Validation{..} = (\v1ValidationMessage -> V1Validation { v1ValidationMessage, ..} ) <$> f v1ValidationMessage
...
v1ValidationMessageExpressionL f V1Validation{..} = (\v1ValidationMessageExpression -> V1Validation { v1ValidationMessageExpression, ..} ) <$> f v1ValidationMessageExpression
{-# INLINE v1ValidationMessageExpressionL #-}

-- | 'v1ValidationReason' Lens
v1ValidationReasonL :: Lens_' V1Validation (Maybe Text)
v1ValidationReasonL f V1Validation{..} = (\v1ValidationReason -> V1Validation { v1ValidationReason, ..} ) <$> f v1ValidationReason
...
v1ValidationRuleOptionalOldSelfL f V1ValidationRule{..} = (\v1ValidationRuleOptionalOldSelf -> V1ValidationRule { v1ValidationRuleOptionalOldSelf, ..} ) <$> f v1ValidationRuleOptionalOldSelf
...
v1VariableExpressionL f V1Variable{..} = (\v1VariableExpression -> V1Variable { v1VariableExpression, ..} ) <$> f v1VariableExpression
{-# INLINE v1VariableExpressionL #-}

-- | 'v1VariableName' Lens
v1VariableNameL :: Lens_' V1Variable (Text)
v1VariableNameL f V1Variable{..} = (\v1VariableName -> V1Variable { v1VariableName, ..} ) <$> f v1VariableName
...
v1VolumeMountRecursiveReadOnlyL f V1VolumeMount{..} = (\v1VolumeMountRecursiveReadOnly -> V1VolumeMount { v1VolumeMountRecursiveReadOnly, ..} ) <$> f v1VolumeMountRecursiveReadOnly
...
v1VolumeMountStatusMountPathL f V1VolumeMountStatus{..} = (\v1VolumeMountStatusMountPath -> V1VolumeMountStatus { v1VolumeMountStatusMountPath, ..} ) <$> f v1VolumeMountStatusMountPath
{-# INLINE v1VolumeMountStatusMountPathL #-}

-- | 'v1VolumeMountStatusName' Lens
v1VolumeMountStatusNameL :: Lens_' V1VolumeMountStatus (Text)
v1VolumeMountStatusNameL f V1VolumeMountStatus{..} = (\v1VolumeMountStatusName -> V1VolumeMountStatus { v1VolumeMountStatusName, ..} ) <$> f v1VolumeMountStatusName
...
v1VolumeMountStatusReadOnlyL f V1VolumeMountStatus{..} = (\v1VolumeMountStatusReadOnly -> V1VolumeMountStatus { v1VolumeMountStatusReadOnly, ..} ) <$> f v1VolumeMountStatusReadOnly
...
v1VolumeMountStatusRecursiveReadOnlyL f V1VolumeMountStatus{..} = (\v1VolumeMountStatusRecursiveReadOnly -> V1VolumeMountStatus { v1VolumeMountStatusRecursiveReadOnly, ..} ) <$> f v1VolumeMountStatusRecursiveReadOnly
...
v1VolumeProjectionClusterTrustBundleL f V1VolumeProjection{..} = (\v1VolumeProjectionClusterTrustBundle -> V1VolumeProjection { v1VolumeProjectionClusterTrustBundle, ..} ) <$> f v1VolumeProjectionClusterTrustBundle
...
v1VolumeResourceRequirementsLimitsL f V1VolumeResourceRequirements{..} = (\v1VolumeResourceRequirementsLimits -> V1VolumeResourceRequirements { v1VolumeResourceRequirementsLimits, ..} ) <$> f v1VolumeResourceRequirementsLimits
...
v1VolumeResourceRequirementsRequestsL f V1VolumeResourceRequirements{..} = (\v1VolumeResourceRequirementsRequests -> V1VolumeResourceRequirements { v1VolumeResourceRequirementsRequests, ..} ) <$> f v1VolumeResourceRequirementsRequests
...
v1alpha1GroupVersionResourceGroupL f V1alpha1GroupVersionResource{..} = (\v1alpha1GroupVersionResourceGroup -> V1alpha1GroupVersionResource { v1alpha1GroupVersionResourceGroup, ..} ) <$> f v1alpha1GroupVersionResourceGroup
...
v1alpha1GroupVersionResourceResourceL f V1alpha1GroupVersionResource{..} = (\v1alpha1GroupVersionResourceResource -> V1alpha1GroupVersionResource { v1alpha1GroupVersionResourceResource, ..} ) <$> f v1alpha1GroupVersionResourceResource
...
v1alpha1GroupVersionResourceVersionL f V1alpha1GroupVersionResource{..} = (\v1alpha1GroupVersionResourceVersion -> V1alpha1GroupVersionResource { v1alpha1GroupVersionResourceVersion, ..} ) <$> f v1alpha1GroupVersionResourceVersion
...
v1alpha1IPAddressSpecParentRefL :: Lens_' V1alpha1IPAddressSpec (V1alpha1ParentReference)
...
v1alpha1MigrationConditionLastUpdateTimeL f V1alpha1MigrationCondition{..} = (\v1alpha1MigrationConditionLastUpdateTime -> V1alpha1MigrationCondition { v1alpha1MigrationConditionLastUpdateTime, ..} ) <$> f v1alpha1MigrationConditionLastUpdateTime
...
v1alpha1MigrationConditionMessageL f V1alpha1MigrationCondition{..} = (\v1alpha1MigrationConditionMessage -> V1alpha1MigrationCondition { v1alpha1MigrationConditionMessage, ..} ) <$> f v1alpha1MigrationConditionMessage
...
v1alpha1MigrationConditionReasonL f V1alpha1MigrationCondition{..} = (\v1alpha1MigrationConditionReason -> V1alpha1MigrationCondition { v1alpha1MigrationConditionReason, ..} ) <$> f v1alpha1MigrationConditionReason
...
v1alpha1MigrationConditionStatusL f V1alpha1MigrationCondition{..} = (\v1alpha1MigrationConditionStatus -> V1alpha1MigrationCondition { v1alpha1MigrationConditionStatus, ..} ) <$> f v1alpha1MigrationConditionStatus
...
v1alpha1MigrationConditionTypeL f V1alpha1MigrationCondition{..} = (\v1alpha1MigrationConditionType -> V1alpha1MigrationCondition { v1alpha1MigrationConditionType, ..} ) <$> f v1alpha1MigrationConditionType
...
v1alpha1ParentReferenceNameL :: Lens_' V1alpha1ParentReference (Text)
...
v1alpha1ParentReferenceResourceL :: Lens_' V1alpha1ParentReference (Text)
...
-- | 'v1alpha1ServiceCIDRApiVersion' Lens
v1alpha1ServiceCIDRApiVersionL :: Lens_' V1alpha1ServiceCIDR (Maybe Text)
v1alpha1ServiceCIDRApiVersionL f V1alpha1ServiceCIDR{..} = (\v1alpha1ServiceCIDRApiVersion -> V1alpha1ServiceCIDR { v1alpha1ServiceCIDRApiVersion, ..} ) <$> f v1alpha1ServiceCIDRApiVersion
{-# INLINE v1alpha1ServiceCIDRApiVersionL #-}

-- | 'v1alpha1ServiceCIDRKind' Lens
v1alpha1ServiceCIDRKindL :: Lens_' V1alpha1ServiceCIDR (Maybe Text)
v1alpha1ServiceCIDRKindL f V1alpha1ServiceCIDR{..} = (\v1alpha1ServiceCIDRKind -> V1alpha1ServiceCIDR { v1alpha1ServiceCIDRKind, ..} ) <$> f v1alpha1ServiceCIDRKind
{-# INLINE v1alpha1ServiceCIDRKindL #-}

-- | 'v1alpha1ServiceCIDRMetadata' Lens
v1alpha1ServiceCIDRMetadataL :: Lens_' V1alpha1ServiceCIDR (Maybe V1ObjectMeta)
v1alpha1ServiceCIDRMetadataL f V1alpha1ServiceCIDR{..} = (\v1alpha1ServiceCIDRMetadata -> V1alpha1ServiceCIDR { v1alpha1ServiceCIDRMetadata, ..} ) <$> f v1alpha1ServiceCIDRMetadata
{-# INLINE v1alpha1ServiceCIDRMetadataL #-}

-- | 'v1alpha1ServiceCIDRSpec' Lens
v1alpha1ServiceCIDRSpecL :: Lens_' V1alpha1ServiceCIDR (Maybe V1alpha1ServiceCIDRSpec)
v1alpha1ServiceCIDRSpecL f V1alpha1ServiceCIDR{..} = (\v1alpha1ServiceCIDRSpec -> V1alpha1ServiceCIDR { v1alpha1ServiceCIDRSpec, ..} ) <$> f v1alpha1ServiceCIDRSpec
{-# INLINE v1alpha1ServiceCIDRSpecL #-}

-- | 'v1alpha1ServiceCIDRStatus' Lens
v1alpha1ServiceCIDRStatusL :: Lens_' V1alpha1ServiceCIDR (Maybe V1alpha1ServiceCIDRStatus)
v1alpha1ServiceCIDRStatusL f V1alpha1ServiceCIDR{..} = (\v1alpha1ServiceCIDRStatus -> V1alpha1ServiceCIDR { v1alpha1ServiceCIDRStatus, ..} ) <$> f v1alpha1ServiceCIDRStatus
{-# INLINE v1alpha1ServiceCIDRStatusL #-}



-- * V1alpha1ServiceCIDRList

-- | 'v1alpha1ServiceCIDRListApiVersion' Lens
v1alpha1ServiceCIDRListApiVersionL :: Lens_' V1alpha1ServiceCIDRList (Maybe Text)
v1alpha1ServiceCIDRListApiVersionL f V1alpha1ServiceCIDRList{..} = (\v1alpha1ServiceCIDRListApiVersion -> V1alpha1ServiceCIDRList { v1alpha1ServiceCIDRListApiVersion, ..} ) <$> f v1alpha1ServiceCIDRListApiVersion
{-# INLINE v1alpha1ServiceCIDRListApiVersionL #-}

-- | 'v1alpha1ServiceCIDRListItems' Lens
v1alpha1ServiceCIDRListItemsL :: Lens_' V1alpha1ServiceCIDRList ([V1alpha1ServiceCIDR])
v1alpha1ServiceCIDRListItemsL f V1alpha1ServiceCIDRList{..} = (\v1alpha1ServiceCIDRListItems -> V1alpha1ServiceCIDRList { v1alpha1ServiceCIDRListItems, ..} ) <$> f v1alpha1ServiceCIDRListItems
{-# INLINE v1alpha1ServiceCIDRListItemsL #-}

-- | 'v1alpha1ServiceCIDRListKind' Lens
v1alpha1ServiceCIDRListKindL :: Lens_' V1alpha1ServiceCIDRList (Maybe Text)
v1alpha1ServiceCIDRListKindL f V1alpha1ServiceCIDRList{..} = (\v1alpha1ServiceCIDRListKind -> V1alpha1ServiceCIDRList { v1alpha1ServiceCIDRListKind, ..} ) <$> f v1alpha1ServiceCIDRListKind
{-# INLINE v1alpha1ServiceCIDRListKindL #-}

-- | 'v1alpha1ServiceCIDRListMetadata' Lens
v1alpha1ServiceCIDRListMetadataL :: Lens_' V1alpha1ServiceCIDRList (Maybe V1ListMeta)
v1alpha1ServiceCIDRListMetadataL f V1alpha1ServiceCIDRList{..} = (\v1alpha1ServiceCIDRListMetadata -> V1alpha1ServiceCIDRList { v1alpha1ServiceCIDRListMetadata, ..} ) <$> f v1alpha1ServiceCIDRListMetadata
{-# INLINE v1alpha1ServiceCIDRListMetadataL #-}



-- * V1alpha1ServiceCIDRSpec

-- | 'v1alpha1ServiceCIDRSpecCidrs' Lens
v1alpha1ServiceCIDRSpecCidrsL :: Lens_' V1alpha1ServiceCIDRSpec (Maybe [Text])
v1alpha1ServiceCIDRSpecCidrsL f V1alpha1ServiceCIDRSpec{..} = (\v1alpha1ServiceCIDRSpecCidrs -> V1alpha1ServiceCIDRSpec { v1alpha1ServiceCIDRSpecCidrs, ..} ) <$> f v1alpha1ServiceCIDRSpecCidrs
{-# INLINE v1alpha1ServiceCIDRSpecCidrsL #-}



-- * V1alpha1ServiceCIDRStatus

-- | 'v1alpha1ServiceCIDRStatusConditions' Lens
v1alpha1ServiceCIDRStatusConditionsL :: Lens_' V1alpha1ServiceCIDRStatus (Maybe [V1Condition])
v1alpha1ServiceCIDRStatusConditionsL f V1alpha1ServiceCIDRStatus{..} = (\v1alpha1ServiceCIDRStatusConditions -> V1alpha1ServiceCIDRStatus { v1alpha1ServiceCIDRStatusConditions, ..} ) <$> f v1alpha1ServiceCIDRStatusConditions
{-# INLINE v1alpha1ServiceCIDRStatusConditionsL #-}
...
v1alpha1StorageVersionMigrationApiVersionL f V1alpha1StorageVersionMigration{..} = (\v1alpha1StorageVersionMigrationApiVersion -> V1alpha1StorageVersionMigration { v1alpha1StorageVersionMigrationApiVersion, ..} ) <$> f v1alpha1StorageVersionMigrationApiVersion
...
v1alpha1StorageVersionMigrationKindL f V1alpha1StorageVersionMigration{..} = (\v1alpha1StorageVersionMigrationKind -> V1alpha1StorageVersionMigration { v1alpha1StorageVersionMigrationKind, ..} ) <$> f v1alpha1StorageVersionMigrationKind
...
v1alpha1StorageVersionMigrationMetadataL f V1alpha1StorageVersionMigration{..} = (\v1alpha1StorageVersionMigrationMetadata -> V1alpha1StorageVersionMigration { v1alpha1StorageVersionMigrationMetadata, ..} ) <$> f v1alpha1StorageVersionMigrationMetadata
...
v1alpha1StorageVersionMigrationSpecL f V1alpha1StorageVersionMigration{..} = (\v1alpha1StorageVersionMigrationSpec -> V1alpha1StorageVersionMigration { v1alpha1StorageVersionMigrationSpec, ..} ) <$> f v1alpha1StorageVersionMigrationSpec
...
v1alpha1StorageVersionMigrationStatusL f V1alpha1StorageVersionMigration{..} = (\v1alpha1StorageVersionMigrationStatus -> V1alpha1StorageVersionMigration { v1alpha1StorageVersionMigrationStatus, ..} ) <$> f v1alpha1StorageVersionMigrationStatus
...
v1alpha1StorageVersionMigrationListApiVersionL f V1alpha1StorageVersionMigrationList{..} = (\v1alpha1StorageVersionMigrationListApiVersion -> V1alpha1StorageVersionMigrationList { v1alpha1StorageVersionMigrationListApiVersion, ..} ) <$> f v1alpha1StorageVersionMigrationListApiVersion
...
v1alpha1StorageVersionMigrationListItemsL f V1alpha1StorageVersionMigrationList{..} = (\v1alpha1StorageVersionMigrationListItems -> V1alpha1StorageVersionMigrationList { v1alpha1StorageVersionMigrationListItems, ..} ) <$> f v1alpha1StorageVersionMigrationListItems
...
v1alpha1StorageVersionMigrationListKindL f V1alpha1StorageVersionMigrationList{..} = (\v1alpha1StorageVersionMigrationListKind -> V1alpha1StorageVersionMigrationList { v1alpha1StorageVersionMigrationListKind, ..} ) <$> f v1alpha1StorageVersionMigrationListKind
...
v1alpha1StorageVersionMigrationListMetadataL f V1alpha1StorageVersionMigrationList{..} = (\v1alpha1StorageVersionMigrationListMetadata -> V1alpha1StorageVersionMigrationList { v1alpha1StorageVersionMigrationListMetadata, ..} ) <$> f v1alpha1StorageVersionMigrationListMetadata
...
v1alpha1StorageVersionMigrationSpecContinueTokenL f V1alpha1StorageVersionMigrationSpec{..} = (\v1alpha1StorageVersionMigrationSpecContinueToken -> V1alpha1StorageVersionMigrationSpec { v1alpha1StorageVersionMigrationSpecContinueToken, ..} ) <$> f v1alpha1StorageVersionMigrationSpecContinueToken
...
v1alpha1StorageVersionMigrationSpecResourceL f V1alpha1StorageVersionMigrationSpec{..} = (\v1alpha1StorageVersionMigrationSpecResource -> V1alpha1StorageVersionMigrationSpec { v1alpha1StorageVersionMigrationSpecResource, ..} ) <$> f v1alpha1StorageVersionMigrationSpecResource
...
v1alpha1StorageVersionMigrationStatusConditionsL f V1alpha1StorageVersionMigrationStatus{..} = (\v1alpha1StorageVersionMigrationStatusConditions -> V1alpha1StorageVersionMigrationStatus { v1alpha1StorageVersionMigrationStatusConditions, ..} ) <$> f v1alpha1StorageVersionMigrationStatusConditions
...
v1alpha1StorageVersionMigrationStatusResourceVersionL f V1alpha1StorageVersionMigrationStatus{..} = (\v1alpha1StorageVersionMigrationStatusResourceVersion -> V1alpha1StorageVersionMigrationStatus { v1alpha1StorageVersionMigrationStatusResourceVersion, ..} ) <$> f v1alpha1StorageVersionMigrationStatusResourceVersion
...
v1alpha1ValidatingAdmissionPolicyBindingListItemsL :: Lens_' V1alpha1ValidatingAdmissionPolicyBindingList ([V1alpha1ValidatingAdmissionPolicyBinding])
...
v1alpha1ValidatingAdmissionPolicyListItemsL :: Lens_' V1alpha1ValidatingAdmissionPolicyList ([V1alpha1ValidatingAdmissionPolicy])
...
v1alpha1VolumeAttributesClassApiVersionL f V1alpha1VolumeAttributesClass{..} = (\v1alpha1VolumeAttributesClassApiVersion -> V1alpha1VolumeAttributesClass { v1alpha1VolumeAttributesClassApiVersion, ..} ) <$> f v1alpha1VolumeAttributesClassApiVersion
...
v1alpha1VolumeAttributesClassDriverNameL f V1alpha1VolumeAttributesClass{..} = (\v1alpha1VolumeAttributesClassDriverName -> V1alpha1VolumeAttributesClass { v1alpha1VolumeAttributesClassDriverName, ..} ) <$> f v1alpha1VolumeAttributesClassDriverName
...
v1alpha1VolumeAttributesClassKindL f V1alpha1VolumeAttributesClass{..} = (\v1alpha1VolumeAttributesClassKind -> V1alpha1VolumeAttributesClass { v1alpha1VolumeAttributesClassKind, ..} ) <$> f v1alpha1VolumeAttributesClassKind
...
v1alpha1VolumeAttributesClassMetadataL f V1alpha1VolumeAttributesClass{..} = (\v1alpha1VolumeAttributesClassMetadata -> V1alpha1VolumeAttributesClass { v1alpha1VolumeAttributesClassMetadata, ..} ) <$> f v1alpha1VolumeAttributesClassMetadata
...
v1alpha1VolumeAttributesClassParametersL f V1alpha1VolumeAttributesClass{..} = (\v1alpha1VolumeAttributesClassParameters -> V1alpha1VolumeAttributesClass { v1alpha1VolumeAttributesClassParameters, ..} ) <$> f v1alpha1VolumeAttributesClassParameters
...
v1alpha1VolumeAttributesClassListApiVersionL f V1alpha1VolumeAttributesClassList{..} = (\v1alpha1VolumeAttributesClassListApiVersion -> V1alpha1VolumeAttributesClassList { v1alpha1VolumeAttributesClassListApiVersion, ..} ) <$> f v1alpha1VolumeAttributesClassListApiVersion
...
v1alpha1VolumeAttributesClassListItemsL f V1alpha1VolumeAttributesClassList{..} = (\v1alpha1VolumeAttributesClassListItems -> V1alpha1VolumeAttributesClassList { v1alpha1VolumeAttributesClassListItems, ..} ) <$> f v1alpha1VolumeAttributesClassListItems
...
v1alpha1VolumeAttributesClassListKindL f V1alpha1VolumeAttributesClassList{..} = (\v1alpha1VolumeAttributesClassListKind -> V1alpha1VolumeAttributesClassList { v1alpha1VolumeAttributesClassListKind, ..} ) <$> f v1alpha1VolumeAttributesClassListKind
...
v1alpha1VolumeAttributesClassListMetadataL f V1alpha1VolumeAttributesClassList{..} = (\v1alpha1VolumeAttributesClassListMetadata -> V1alpha1VolumeAttributesClassList { v1alpha1VolumeAttributesClassListMetadata, ..} ) <$> f v1alpha1VolumeAttributesClassListMetadata
...
-- | 'v1alpha2DriverAllocationResultNamedResources' Lens
v1alpha2DriverAllocationResultNamedResourcesL :: Lens_' V1alpha2DriverAllocationResult (Maybe V1alpha2NamedResourcesAllocationResult)
v1alpha2DriverAllocationResultNamedResourcesL f V1alpha2DriverAllocationResult{..} = (\v1alpha2DriverAllocationResultNamedResources -> V1alpha2DriverAllocationResult { v1alpha2DriverAllocationResultNamedResources, ..} ) <$> f v1alpha2DriverAllocationResultNamedResources
{-# INLINE v1alpha2DriverAllocationResultNamedResourcesL #-}

-- | 'v1alpha2DriverAllocationResultVendorRequestParameters' Lens
v1alpha2DriverAllocationResultVendorRequestParametersL :: Lens_' V1alpha2DriverAllocationResult (Maybe A.Value)
v1alpha2DriverAllocationResultVendorRequestParametersL f V1alpha2DriverAllocationResult{..} = (\v1alpha2DriverAllocationResultVendorRequestParameters -> V1alpha2DriverAllocationResult { v1alpha2DriverAllocationResultVendorRequestParameters, ..} ) <$> f v1alpha2DriverAllocationResultVendorRequestParameters
{-# INLINE v1alpha2DriverAllocationResultVendorRequestParametersL #-}



-- * V1alpha2DriverRequests

-- | 'v1alpha2DriverRequestsDriverName' Lens
v1alpha2DriverRequestsDriverNameL :: Lens_' V1alpha2DriverRequests (Maybe Text)
v1alpha2DriverRequestsDriverNameL f V1alpha2DriverRequests{..} = (\v1alpha2DriverRequestsDriverName -> V1alpha2DriverRequests { v1alpha2DriverRequestsDriverName, ..} ) <$> f v1alpha2DriverRequestsDriverName
{-# INLINE v1alpha2DriverRequestsDriverNameL #-}

-- | 'v1alpha2DriverRequestsRequests' Lens
v1alpha2DriverRequestsRequestsL :: Lens_' V1alpha2DriverRequests (Maybe [V1alpha2ResourceRequest])
v1alpha2DriverRequestsRequestsL f V1alpha2DriverRequests{..} = (\v1alpha2DriverRequestsRequests -> V1alpha2DriverRequests { v1alpha2DriverRequestsRequests, ..} ) <$> f v1alpha2DriverRequestsRequests
{-# INLINE v1alpha2DriverRequestsRequestsL #-}

-- | 'v1alpha2DriverRequestsVendorParameters' Lens
v1alpha2DriverRequestsVendorParametersL :: Lens_' V1alpha2DriverRequests (Maybe A.Value)
v1alpha2DriverRequestsVendorParametersL f V1alpha2DriverRequests{..} = (\v1alpha2DriverRequestsVendorParameters -> V1alpha2DriverRequests { v1alpha2DriverRequestsVendorParameters, ..} ) <$> f v1alpha2DriverRequestsVendorParameters
{-# INLINE v1alpha2DriverRequestsVendorParametersL #-}



-- * V1alpha2NamedResourcesAllocationResult

-- | 'v1alpha2NamedResourcesAllocationResultName' Lens
v1alpha2NamedResourcesAllocationResultNameL :: Lens_' V1alpha2NamedResourcesAllocationResult (Text)
v1alpha2NamedResourcesAllocationResultNameL f V1alpha2NamedResourcesAllocationResult{..} = (\v1alpha2NamedResourcesAllocationResultName -> V1alpha2NamedResourcesAllocationResult { v1alpha2NamedResourcesAllocationResultName, ..} ) <$> f v1alpha2NamedResourcesAllocationResultName
{-# INLINE v1alpha2NamedResourcesAllocationResultNameL #-}



-- * V1alpha2NamedResourcesAttribute

-- | 'v1alpha2NamedResourcesAttributeBool' Lens
v1alpha2NamedResourcesAttributeBoolL :: Lens_' V1alpha2NamedResourcesAttribute (Maybe Bool)
v1alpha2NamedResourcesAttributeBoolL f V1alpha2NamedResourcesAttribute{..} = (\v1alpha2NamedResourcesAttributeBool -> V1alpha2NamedResourcesAttribute { v1alpha2NamedResourcesAttributeBool, ..} ) <$> f v1alpha2NamedResourcesAttributeBool
{-# INLINE v1alpha2NamedResourcesAttributeBoolL #-}

-- | 'v1alpha2NamedResourcesAttributeInt' Lens
v1alpha2NamedResourcesAttributeIntL :: Lens_' V1alpha2NamedResourcesAttribute (Maybe Integer)
v1alpha2NamedResourcesAttributeIntL f V1alpha2NamedResourcesAttribute{..} = (\v1alpha2NamedResourcesAttributeInt -> V1alpha2NamedResourcesAttribute { v1alpha2NamedResourcesAttributeInt, ..} ) <$> f v1alpha2NamedResourcesAttributeInt
{-# INLINE v1alpha2NamedResourcesAttributeIntL #-}

-- | 'v1alpha2NamedResourcesAttributeIntSlice' Lens
v1alpha2NamedResourcesAttributeIntSliceL :: Lens_' V1alpha2NamedResourcesAttribute (Maybe V1alpha2NamedResourcesIntSlice)
v1alpha2NamedResourcesAttributeIntSliceL f V1alpha2NamedResourcesAttribute{..} = (\v1alpha2NamedResourcesAttributeIntSlice -> V1alpha2NamedResourcesAttribute { v1alpha2NamedResourcesAttributeIntSlice, ..} ) <$> f v1alpha2NamedResourcesAttributeIntSlice
{-# INLINE v1alpha2NamedResourcesAttributeIntSliceL #-}

-- | 'v1alpha2NamedResourcesAttributeName' Lens
v1alpha2NamedResourcesAttributeNameL :: Lens_' V1alpha2NamedResourcesAttribute (Text)
v1alpha2NamedResourcesAttributeNameL f V1alpha2NamedResourcesAttribute{..} = (\v1alpha2NamedResourcesAttributeName -> V1alpha2NamedResourcesAttribute { v1alpha2NamedResourcesAttributeName, ..} ) <$> f v1alpha2NamedResourcesAttributeName
{-# INLINE v1alpha2NamedResourcesAttributeNameL #-}

-- | 'v1alpha2NamedResourcesAttributeQuantity' Lens
v1alpha2NamedResourcesAttributeQuantityL :: Lens_' V1alpha2NamedResourcesAttribute (Maybe Quantity)
v1alpha2NamedResourcesAttributeQuantityL f V1alpha2NamedResourcesAttribute{..} = (\v1alpha2NamedResourcesAttributeQuantity -> V1alpha2NamedResourcesAttribute { v1alpha2NamedResourcesAttributeQuantity, ..} ) <$> f v1alpha2NamedResourcesAttributeQuantity
{-# INLINE v1alpha2NamedResourcesAttributeQuantityL #-}

-- | 'v1alpha2NamedResourcesAttributeString' Lens
v1alpha2NamedResourcesAttributeStringL :: Lens_' V1alpha2NamedResourcesAttribute (Maybe Text)
v1alpha2NamedResourcesAttributeStringL f V1alpha2NamedResourcesAttribute{..} = (\v1alpha2NamedResourcesAttributeString -> V1alpha2NamedResourcesAttribute { v1alpha2NamedResourcesAttributeString, ..} ) <$> f v1alpha2NamedResourcesAttributeString
{-# INLINE v1alpha2NamedResourcesAttributeStringL #-}

-- | 'v1alpha2NamedResourcesAttributeStringSlice' Lens
v1alpha2NamedResourcesAttributeStringSliceL :: Lens_' V1alpha2NamedResourcesAttribute (Maybe V1alpha2NamedResourcesStringSlice)
v1alpha2NamedResourcesAttributeStringSliceL f V1alpha2NamedResourcesAttribute{..} = (\v1alpha2NamedResourcesAttributeStringSlice -> V1alpha2NamedResourcesAttribute { v1alpha2NamedResourcesAttributeStringSlice, ..} ) <$> f v1alpha2NamedResourcesAttributeStringSlice
{-# INLINE v1alpha2NamedResourcesAttributeStringSliceL #-}

-- | 'v1alpha2NamedResourcesAttributeVersion' Lens
v1alpha2NamedResourcesAttributeVersionL :: Lens_' V1alpha2NamedResourcesAttribute (Maybe Text)
v1alpha2NamedResourcesAttributeVersionL f V1alpha2NamedResourcesAttribute{..} = (\v1alpha2NamedResourcesAttributeVersion -> V1alpha2NamedResourcesAttribute { v1alpha2NamedResourcesAttributeVersion, ..} ) <$> f v1alpha2NamedResourcesAttributeVersion
{-# INLINE v1alpha2NamedResourcesAttributeVersionL #-}



-- * V1alpha2NamedResourcesFilter

-- | 'v1alpha2NamedResourcesFilterSelector' Lens
v1alpha2NamedResourcesFilterSelectorL :: Lens_' V1alpha2NamedResourcesFilter (Text)
v1alpha2NamedResourcesFilterSelectorL f V1alpha2NamedResourcesFilter{..} = (\v1alpha2NamedResourcesFilterSelector -> V1alpha2NamedResourcesFilter { v1alpha2NamedResourcesFilterSelector, ..} ) <$> f v1alpha2NamedResourcesFilterSelector
{-# INLINE v1alpha2NamedResourcesFilterSelectorL #-}



-- * V1alpha2NamedResourcesInstance

-- | 'v1alpha2NamedResourcesInstanceAttributes' Lens
v1alpha2NamedResourcesInstanceAttributesL :: Lens_' V1alpha2NamedResourcesInstance (Maybe [V1alpha2NamedResourcesAttribute])
v1alpha2NamedResourcesInstanceAttributesL f V1alpha2NamedResourcesInstance{..} = (\v1alpha2NamedResourcesInstanceAttributes -> V1alpha2NamedResourcesInstance { v1alpha2NamedResourcesInstanceAttributes, ..} ) <$> f v1alpha2NamedResourcesInstanceAttributes
{-# INLINE v1alpha2NamedResourcesInstanceAttributesL #-}

-- | 'v1alpha2NamedResourcesInstanceName' Lens
v1alpha2NamedResourcesInstanceNameL :: Lens_' V1alpha2NamedResourcesInstance (Text)
v1alpha2NamedResourcesInstanceNameL f V1alpha2NamedResourcesInstance{..} = (\v1alpha2NamedResourcesInstanceName -> V1alpha2NamedResourcesInstance { v1alpha2NamedResourcesInstanceName, ..} ) <$> f v1alpha2NamedResourcesInstanceName
{-# INLINE v1alpha2NamedResourcesInstanceNameL #-}



-- * V1alpha2NamedResourcesIntSlice

-- | 'v1alpha2NamedResourcesIntSliceInts' Lens
v1alpha2NamedResourcesIntSliceIntsL :: Lens_' V1alpha2NamedResourcesIntSlice ([Integer])
v1alpha2NamedResourcesIntSliceIntsL f V1alpha2NamedResourcesIntSlice{..} = (\v1alpha2NamedResourcesIntSliceInts -> V1alpha2NamedResourcesIntSlice { v1alpha2NamedResourcesIntSliceInts, ..} ) <$> f v1alpha2NamedResourcesIntSliceInts
{-# INLINE v1alpha2NamedResourcesIntSliceIntsL #-}



-- * V1alpha2NamedResourcesRequest

-- | 'v1alpha2NamedResourcesRequestSelector' Lens
v1alpha2NamedResourcesRequestSelectorL :: Lens_' V1alpha2NamedResourcesRequest (Text)
v1alpha2NamedResourcesRequestSelectorL f V1alpha2NamedResourcesRequest{..} = (\v1alpha2NamedResourcesRequestSelector -> V1alpha2NamedResourcesRequest { v1alpha2NamedResourcesRequestSelector, ..} ) <$> f v1alpha2NamedResourcesRequestSelector
{-# INLINE v1alpha2NamedResourcesRequestSelectorL #-}



-- * V1alpha2NamedResourcesResources

-- | 'v1alpha2NamedResourcesResourcesInstances' Lens
v1alpha2NamedResourcesResourcesInstancesL :: Lens_' V1alpha2NamedResourcesResources ([V1alpha2NamedResourcesInstance])
v1alpha2NamedResourcesResourcesInstancesL f V1alpha2NamedResourcesResources{..} = (\v1alpha2NamedResourcesResourcesInstances -> V1alpha2NamedResourcesResources { v1alpha2NamedResourcesResourcesInstances, ..} ) <$> f v1alpha2NamedResourcesResourcesInstances
{-# INLINE v1alpha2NamedResourcesResourcesInstancesL #-}



-- * V1alpha2NamedResourcesStringSlice

-- | 'v1alpha2NamedResourcesStringSliceStrings' Lens
v1alpha2NamedResourcesStringSliceStringsL :: Lens_' V1alpha2NamedResourcesStringSlice ([Text])
v1alpha2NamedResourcesStringSliceStringsL f V1alpha2NamedResourcesStringSlice{..} = (\v1alpha2NamedResourcesStringSliceStrings -> V1alpha2NamedResourcesStringSlice { v1alpha2NamedResourcesStringSliceStrings, ..} ) <$> f v1alpha2NamedResourcesStringSliceStrings
{-# INLINE v1alpha2NamedResourcesStringSliceStringsL #-}
...
-- | 'v1alpha2ResourceClaimParametersApiVersion' Lens
v1alpha2ResourceClaimParametersApiVersionL :: Lens_' V1alpha2ResourceClaimParameters (Maybe Text)
v1alpha2ResourceClaimParametersApiVersionL f V1alpha2ResourceClaimParameters{..} = (\v1alpha2ResourceClaimParametersApiVersion -> V1alpha2ResourceClaimParameters { v1alpha2ResourceClaimParametersApiVersion, ..} ) <$> f v1alpha2ResourceClaimParametersApiVersion
{-# INLINE v1alpha2ResourceClaimParametersApiVersionL #-}

-- | 'v1alpha2ResourceClaimParametersDriverRequests' Lens
v1alpha2ResourceClaimParametersDriverRequestsL :: Lens_' V1alpha2ResourceClaimParameters (Maybe [V1alpha2DriverRequests])
v1alpha2ResourceClaimParametersDriverRequestsL f V1alpha2ResourceClaimParameters{..} = (\v1alpha2ResourceClaimParametersDriverRequests -> V1alpha2ResourceClaimParameters { v1alpha2ResourceClaimParametersDriverRequests, ..} ) <$> f v1alpha2ResourceClaimParametersDriverRequests
{-# INLINE v1alpha2ResourceClaimParametersDriverRequestsL #-}

-- | 'v1alpha2ResourceClaimParametersGeneratedFrom' Lens
v1alpha2ResourceClaimParametersGeneratedFromL :: Lens_' V1alpha2ResourceClaimParameters (Maybe V1alpha2ResourceClaimParametersReference)
v1alpha2ResourceClaimParametersGeneratedFromL f V1alpha2ResourceClaimParameters{..} = (\v1alpha2ResourceClaimParametersGeneratedFrom -> V1alpha2ResourceClaimParameters { v1alpha2ResourceClaimParametersGeneratedFrom, ..} ) <$> f v1alpha2ResourceClaimParametersGeneratedFrom
{-# INLINE v1alpha2ResourceClaimParametersGeneratedFromL #-}

-- | 'v1alpha2ResourceClaimParametersKind' Lens
v1alpha2ResourceClaimParametersKindL :: Lens_' V1alpha2ResourceClaimParameters (Maybe Text)
v1alpha2ResourceClaimParametersKindL f V1alpha2ResourceClaimParameters{..} = (\v1alpha2ResourceClaimParametersKind -> V1alpha2ResourceClaimParameters { v1alpha2ResourceClaimParametersKind, ..} ) <$> f v1alpha2ResourceClaimParametersKind
{-# INLINE v1alpha2ResourceClaimParametersKindL #-}

-- | 'v1alpha2ResourceClaimParametersMetadata' Lens
v1alpha2ResourceClaimParametersMetadataL :: Lens_' V1alpha2ResourceClaimParameters (Maybe V1ObjectMeta)
v1alpha2ResourceClaimParametersMetadataL f V1alpha2ResourceClaimParameters{..} = (\v1alpha2ResourceClaimParametersMetadata -> V1alpha2ResourceClaimParameters { v1alpha2ResourceClaimParametersMetadata, ..} ) <$> f v1alpha2ResourceClaimParametersMetadata
{-# INLINE v1alpha2ResourceClaimParametersMetadataL #-}

-- | 'v1alpha2ResourceClaimParametersShareable' Lens
v1alpha2ResourceClaimParametersShareableL :: Lens_' V1alpha2ResourceClaimParameters (Maybe Bool)
v1alpha2ResourceClaimParametersShareableL f V1alpha2ResourceClaimParameters{..} = (\v1alpha2ResourceClaimParametersShareable -> V1alpha2ResourceClaimParameters { v1alpha2ResourceClaimParametersShareable, ..} ) <$> f v1alpha2ResourceClaimParametersShareable
{-# INLINE v1alpha2ResourceClaimParametersShareableL #-}



-- * V1alpha2ResourceClaimParametersList

-- | 'v1alpha2ResourceClaimParametersListApiVersion' Lens
v1alpha2ResourceClaimParametersListApiVersionL :: Lens_' V1alpha2ResourceClaimParametersList (Maybe Text)
v1alpha2ResourceClaimParametersListApiVersionL f V1alpha2ResourceClaimParametersList{..} = (\v1alpha2ResourceClaimParametersListApiVersion -> V1alpha2ResourceClaimParametersList { v1alpha2ResourceClaimParametersListApiVersion, ..} ) <$> f v1alpha2ResourceClaimParametersListApiVersion
{-# INLINE v1alpha2ResourceClaimParametersListApiVersionL #-}

-- | 'v1alpha2ResourceClaimParametersListItems' Lens
v1alpha2ResourceClaimParametersListItemsL :: Lens_' V1alpha2ResourceClaimParametersList ([V1alpha2ResourceClaimParameters])
v1alpha2ResourceClaimParametersListItemsL f V1alpha2ResourceClaimParametersList{..} = (\v1alpha2ResourceClaimParametersListItems -> V1alpha2ResourceClaimParametersList { v1alpha2ResourceClaimParametersListItems, ..} ) <$> f v1alpha2ResourceClaimParametersListItems
{-# INLINE v1alpha2ResourceClaimParametersListItemsL #-}

-- | 'v1alpha2ResourceClaimParametersListKind' Lens
v1alpha2ResourceClaimParametersListKindL :: Lens_' V1alpha2ResourceClaimParametersList (Maybe Text)
v1alpha2ResourceClaimParametersListKindL f V1alpha2ResourceClaimParametersList{..} = (\v1alpha2ResourceClaimParametersListKind -> V1alpha2ResourceClaimParametersList { v1alpha2ResourceClaimParametersListKind, ..} ) <$> f v1alpha2ResourceClaimParametersListKind
{-# INLINE v1alpha2ResourceClaimParametersListKindL #-}

-- | 'v1alpha2ResourceClaimParametersListMetadata' Lens
v1alpha2ResourceClaimParametersListMetadataL :: Lens_' V1alpha2ResourceClaimParametersList (Maybe V1ListMeta)
v1alpha2ResourceClaimParametersListMetadataL f V1alpha2ResourceClaimParametersList{..} = (\v1alpha2ResourceClaimParametersListMetadata -> V1alpha2ResourceClaimParametersList { v1alpha2ResourceClaimParametersListMetadata, ..} ) <$> f v1alpha2ResourceClaimParametersListMetadata
{-# INLINE v1alpha2ResourceClaimParametersListMetadataL #-}
...
-- | 'v1alpha2ResourceClassStructuredParameters' Lens
v1alpha2ResourceClassStructuredParametersL :: Lens_' V1alpha2ResourceClass (Maybe Bool)
v1alpha2ResourceClassStructuredParametersL f V1alpha2ResourceClass{..} = (\v1alpha2ResourceClassStructuredParameters -> V1alpha2ResourceClass { v1alpha2ResourceClassStructuredParameters, ..} ) <$> f v1alpha2ResourceClassStructuredParameters
{-# INLINE v1alpha2ResourceClassStructuredParametersL #-}
...
-- | 'v1alpha2ResourceClassParametersApiVersion' Lens
v1alpha2ResourceClassParametersApiVersionL :: Lens_' V1alpha2ResourceClassParameters (Maybe Text)
v1alpha2ResourceClassParametersApiVersionL f V1alpha2ResourceClassParameters{..} = (\v1alpha2ResourceClassParametersApiVersion -> V1alpha2ResourceClassParameters { v1alpha2ResourceClassParametersApiVersion, ..} ) <$> f v1alpha2ResourceClassParametersApiVersion
{-# INLINE v1alpha2ResourceClassParametersApiVersionL #-}

-- | 'v1alpha2ResourceClassParametersFilters' Lens
v1alpha2ResourceClassParametersFiltersL :: Lens_' V1alpha2ResourceClassParameters (Maybe [V1alpha2ResourceFilter])
v1alpha2ResourceClassParametersFiltersL f V1alpha2ResourceClassParameters{..} = (\v1alpha2ResourceClassParametersFilters -> V1alpha2ResourceClassParameters { v1alpha2ResourceClassParametersFilters, ..} ) <$> f v1alpha2ResourceClassParametersFilters
{-# INLINE v1alpha2ResourceClassParametersFiltersL #-}

-- | 'v1alpha2ResourceClassParametersGeneratedFrom' Lens
v1alpha2ResourceClassParametersGeneratedFromL :: Lens_' V1alpha2ResourceClassParameters (Maybe V1alpha2ResourceClassParametersReference)
v1alpha2ResourceClassParametersGeneratedFromL f V1alpha2ResourceClassParameters{..} = (\v1alpha2ResourceClassParametersGeneratedFrom -> V1alpha2ResourceClassParameters { v1alpha2ResourceClassParametersGeneratedFrom, ..} ) <$> f v1alpha2ResourceClassParametersGeneratedFrom
{-# INLINE v1alpha2ResourceClassParametersGeneratedFromL #-}

-- | 'v1alpha2ResourceClassParametersKind' Lens
v1alpha2ResourceClassParametersKindL :: Lens_' V1alpha2ResourceClassParameters (Maybe Text)
v1alpha2ResourceClassParametersKindL f V1alpha2ResourceClassParameters{..} = (\v1alpha2ResourceClassParametersKind -> V1alpha2ResourceClassParameters { v1alpha2ResourceClassParametersKind, ..} ) <$> f v1alpha2ResourceClassParametersKind
{-# INLINE v1alpha2ResourceClassParametersKindL #-}

-- | 'v1alpha2ResourceClassParametersMetadata' Lens
v1alpha2ResourceClassParametersMetadataL :: Lens_' V1alpha2ResourceClassParameters (Maybe V1ObjectMeta)
v1alpha2ResourceClassParametersMetadataL f V1alpha2ResourceClassParameters{..} = (\v1alpha2ResourceClassParametersMetadata -> V1alpha2ResourceClassParameters { v1alpha2ResourceClassParametersMetadata, ..} ) <$> f v1alpha2ResourceClassParametersMetadata
{-# INLINE v1alpha2ResourceClassParametersMetadataL #-}

-- | 'v1alpha2ResourceClassParametersVendorParameters' Lens
v1alpha2ResourceClassParametersVendorParametersL :: Lens_' V1alpha2ResourceClassParameters (Maybe [V1alpha2VendorParameters])
v1alpha2ResourceClassParametersVendorParametersL f V1alpha2ResourceClassParameters{..} = (\v1alpha2ResourceClassParametersVendorParameters -> V1alpha2ResourceClassParameters { v1alpha2ResourceClassParametersVendorParameters, ..} ) <$> f v1alpha2ResourceClassParametersVendorParameters
{-# INLINE v1alpha2ResourceClassParametersVendorParametersL #-}



-- * V1alpha2ResourceClassParametersList

-- | 'v1alpha2ResourceClassParametersListApiVersion' Lens
v1alpha2ResourceClassParametersListApiVersionL :: Lens_' V1alpha2ResourceClassParametersList (Maybe Text)
v1alpha2ResourceClassParametersListApiVersionL f V1alpha2ResourceClassParametersList{..} = (\v1alpha2ResourceClassParametersListApiVersion -> V1alpha2ResourceClassParametersList { v1alpha2ResourceClassParametersListApiVersion, ..} ) <$> f v1alpha2ResourceClassParametersListApiVersion
{-# INLINE v1alpha2ResourceClassParametersListApiVersionL #-}

-- | 'v1alpha2ResourceClassParametersListItems' Lens
v1alpha2ResourceClassParametersListItemsL :: Lens_' V1alpha2ResourceClassParametersList ([V1alpha2ResourceClassParameters])
v1alpha2ResourceClassParametersListItemsL f V1alpha2ResourceClassParametersList{..} = (\v1alpha2ResourceClassParametersListItems -> V1alpha2ResourceClassParametersList { v1alpha2ResourceClassParametersListItems, ..} ) <$> f v1alpha2ResourceClassParametersListItems
{-# INLINE v1alpha2ResourceClassParametersListItemsL #-}

-- | 'v1alpha2ResourceClassParametersListKind' Lens
v1alpha2ResourceClassParametersListKindL :: Lens_' V1alpha2ResourceClassParametersList (Maybe Text)
v1alpha2ResourceClassParametersListKindL f V1alpha2ResourceClassParametersList{..} = (\v1alpha2ResourceClassParametersListKind -> V1alpha2ResourceClassParametersList { v1alpha2ResourceClassParametersListKind, ..} ) <$> f v1alpha2ResourceClassParametersListKind
{-# INLINE v1alpha2ResourceClassParametersListKindL #-}

-- | 'v1alpha2ResourceClassParametersListMetadata' Lens
v1alpha2ResourceClassParametersListMetadataL :: Lens_' V1alpha2ResourceClassParametersList (Maybe V1ListMeta)
v1alpha2ResourceClassParametersListMetadataL f V1alpha2ResourceClassParametersList{..} = (\v1alpha2ResourceClassParametersListMetadata -> V1alpha2ResourceClassParametersList { v1alpha2ResourceClassParametersListMetadata, ..} ) <$> f v1alpha2ResourceClassParametersListMetadata
{-# INLINE v1alpha2ResourceClassParametersListMetadataL #-}
...
-- | 'v1alpha2ResourceFilterDriverName' Lens
v1alpha2ResourceFilterDriverNameL :: Lens_' V1alpha2ResourceFilter (Maybe Text)
v1alpha2ResourceFilterDriverNameL f V1alpha2ResourceFilter{..} = (\v1alpha2ResourceFilterDriverName -> V1alpha2ResourceFilter { v1alpha2ResourceFilterDriverName, ..} ) <$> f v1alpha2ResourceFilterDriverName
{-# INLINE v1alpha2ResourceFilterDriverNameL #-}

-- | 'v1alpha2ResourceFilterNamedResources' Lens
v1alpha2ResourceFilterNamedResourcesL :: Lens_' V1alpha2ResourceFilter (Maybe V1alpha2NamedResourcesFilter)
v1alpha2ResourceFilterNamedResourcesL f V1alpha2ResourceFilter{..} = (\v1alpha2ResourceFilterNamedResources -> V1alpha2ResourceFilter { v1alpha2ResourceFilterNamedResources, ..} ) <$> f v1alpha2ResourceFilterNamedResources
{-# INLINE v1alpha2ResourceFilterNamedResourcesL #-}
...
-- | 'v1alpha2ResourceHandleStructuredData' Lens
v1alpha2ResourceHandleStructuredDataL :: Lens_' V1alpha2ResourceHandle (Maybe V1alpha2StructuredResourceHandle)
v1alpha2ResourceHandleStructuredDataL f V1alpha2ResourceHandle{..} = (\v1alpha2ResourceHandleStructuredData -> V1alpha2ResourceHandle { v1alpha2ResourceHandleStructuredData, ..} ) <$> f v1alpha2ResourceHandleStructuredData
{-# INLINE v1alpha2ResourceHandleStructuredDataL #-}



-- * V1alpha2ResourceRequest

-- | 'v1alpha2ResourceRequestNamedResources' Lens
v1alpha2ResourceRequestNamedResourcesL :: Lens_' V1alpha2ResourceRequest (Maybe V1alpha2NamedResourcesRequest)
v1alpha2ResourceRequestNamedResourcesL f V1alpha2ResourceRequest{..} = (\v1alpha2ResourceRequestNamedResources -> V1alpha2ResourceRequest { v1alpha2ResourceRequestNamedResources, ..} ) <$> f v1alpha2ResourceRequestNamedResources
{-# INLINE v1alpha2ResourceRequestNamedResourcesL #-}

-- | 'v1alpha2ResourceRequestVendorParameters' Lens
v1alpha2ResourceRequestVendorParametersL :: Lens_' V1alpha2ResourceRequest (Maybe A.Value)
v1alpha2ResourceRequestVendorParametersL f V1alpha2ResourceRequest{..} = (\v1alpha2ResourceRequestVendorParameters -> V1alpha2ResourceRequest { v1alpha2ResourceRequestVendorParameters, ..} ) <$> f v1alpha2ResourceRequestVendorParameters
{-# INLINE v1alpha2ResourceRequestVendorParametersL #-}



-- * V1alpha2ResourceSlice

-- | 'v1alpha2ResourceSliceApiVersion' Lens
v1alpha2ResourceSliceApiVersionL :: Lens_' V1alpha2ResourceSlice (Maybe Text)
v1alpha2ResourceSliceApiVersionL f V1alpha2ResourceSlice{..} = (\v1alpha2ResourceSliceApiVersion -> V1alpha2ResourceSlice { v1alpha2ResourceSliceApiVersion, ..} ) <$> f v1alpha2ResourceSliceApiVersion
{-# INLINE v1alpha2ResourceSliceApiVersionL #-}

-- | 'v1alpha2ResourceSliceDriverName' Lens
v1alpha2ResourceSliceDriverNameL :: Lens_' V1alpha2ResourceSlice (Text)
v1alpha2ResourceSliceDriverNameL f V1alpha2ResourceSlice{..} = (\v1alpha2ResourceSliceDriverName -> V1alpha2ResourceSlice { v1alpha2ResourceSliceDriverName, ..} ) <$> f v1alpha2ResourceSliceDriverName
{-# INLINE v1alpha2ResourceSliceDriverNameL #-}

-- | 'v1alpha2ResourceSliceKind' Lens
v1alpha2ResourceSliceKindL :: Lens_' V1alpha2ResourceSlice (Maybe Text)
v1alpha2ResourceSliceKindL f V1alpha2ResourceSlice{..} = (\v1alpha2ResourceSliceKind -> V1alpha2ResourceSlice { v1alpha2ResourceSliceKind, ..} ) <$> f v1alpha2ResourceSliceKind
{-# INLINE v1alpha2ResourceSliceKindL #-}

-- | 'v1alpha2ResourceSliceMetadata' Lens
v1alpha2ResourceSliceMetadataL :: Lens_' V1alpha2ResourceSlice (Maybe V1ObjectMeta)
v1alpha2ResourceSliceMetadataL f V1alpha2ResourceSlice{..} = (\v1alpha2ResourceSliceMetadata -> V1alpha2ResourceSlice { v1alpha2ResourceSliceMetadata, ..} ) <$> f v1alpha2ResourceSliceMetadata
{-# INLINE v1alpha2ResourceSliceMetadataL #-}

-- | 'v1alpha2ResourceSliceNamedResources' Lens
v1alpha2ResourceSliceNamedResourcesL :: Lens_' V1alpha2ResourceSlice (Maybe V1alpha2NamedResourcesResources)
v1alpha2ResourceSliceNamedResourcesL f V1alpha2ResourceSlice{..} = (\v1alpha2ResourceSliceNamedResources -> V1alpha2ResourceSlice { v1alpha2ResourceSliceNamedResources, ..} ) <$> f v1alpha2ResourceSliceNamedResources
{-# INLINE v1alpha2ResourceSliceNamedResourcesL #-}

-- | 'v1alpha2ResourceSliceNodeName' Lens
v1alpha2ResourceSliceNodeNameL :: Lens_' V1alpha2ResourceSlice (Maybe Text)
v1alpha2ResourceSliceNodeNameL f V1alpha2ResourceSlice{..} = (\v1alpha2ResourceSliceNodeName -> V1alpha2ResourceSlice { v1alpha2ResourceSliceNodeName, ..} ) <$> f v1alpha2ResourceSliceNodeName
{-# INLINE v1alpha2ResourceSliceNodeNameL #-}



-- * V1alpha2ResourceSliceList

-- | 'v1alpha2ResourceSliceListApiVersion' Lens
v1alpha2ResourceSliceListApiVersionL :: Lens_' V1alpha2ResourceSliceList (Maybe Text)
v1alpha2ResourceSliceListApiVersionL f V1alpha2ResourceSliceList{..} = (\v1alpha2ResourceSliceListApiVersion -> V1alpha2ResourceSliceList { v1alpha2ResourceSliceListApiVersion, ..} ) <$> f v1alpha2ResourceSliceListApiVersion
{-# INLINE v1alpha2ResourceSliceListApiVersionL #-}

-- | 'v1alpha2ResourceSliceListItems' Lens
v1alpha2ResourceSliceListItemsL :: Lens_' V1alpha2ResourceSliceList ([V1alpha2ResourceSlice])
v1alpha2ResourceSliceListItemsL f V1alpha2ResourceSliceList{..} = (\v1alpha2ResourceSliceListItems -> V1alpha2ResourceSliceList { v1alpha2ResourceSliceListItems, ..} ) <$> f v1alpha2ResourceSliceListItems
{-# INLINE v1alpha2ResourceSliceListItemsL #-}

-- | 'v1alpha2ResourceSliceListKind' Lens
v1alpha2ResourceSliceListKindL :: Lens_' V1alpha2ResourceSliceList (Maybe Text)
v1alpha2ResourceSliceListKindL f V1alpha2ResourceSliceList{..} = (\v1alpha2ResourceSliceListKind -> V1alpha2ResourceSliceList { v1alpha2ResourceSliceListKind, ..} ) <$> f v1alpha2ResourceSliceListKind
{-# INLINE v1alpha2ResourceSliceListKindL #-}

-- | 'v1alpha2ResourceSliceListMetadata' Lens
v1alpha2ResourceSliceListMetadataL :: Lens_' V1alpha2ResourceSliceList (Maybe V1ListMeta)
v1alpha2ResourceSliceListMetadataL f V1alpha2ResourceSliceList{..} = (\v1alpha2ResourceSliceListMetadata -> V1alpha2ResourceSliceList { v1alpha2ResourceSliceListMetadata, ..} ) <$> f v1alpha2ResourceSliceListMetadata
{-# INLINE v1alpha2ResourceSliceListMetadataL #-}



-- * V1alpha2StructuredResourceHandle

-- | 'v1alpha2StructuredResourceHandleNodeName' Lens
v1alpha2StructuredResourceHandleNodeNameL :: Lens_' V1alpha2StructuredResourceHandle (Maybe Text)
v1alpha2StructuredResourceHandleNodeNameL f V1alpha2StructuredResourceHandle{..} = (\v1alpha2StructuredResourceHandleNodeName -> V1alpha2StructuredResourceHandle { v1alpha2StructuredResourceHandleNodeName, ..} ) <$> f v1alpha2StructuredResourceHandleNodeName
{-# INLINE v1alpha2StructuredResourceHandleNodeNameL #-}

-- | 'v1alpha2StructuredResourceHandleResults' Lens
v1alpha2StructuredResourceHandleResultsL :: Lens_' V1alpha2StructuredResourceHandle ([V1alpha2DriverAllocationResult])
v1alpha2StructuredResourceHandleResultsL f V1alpha2StructuredResourceHandle{..} = (\v1alpha2StructuredResourceHandleResults -> V1alpha2StructuredResourceHandle { v1alpha2StructuredResourceHandleResults, ..} ) <$> f v1alpha2StructuredResourceHandleResults
{-# INLINE v1alpha2StructuredResourceHandleResultsL #-}

-- | 'v1alpha2StructuredResourceHandleVendorClaimParameters' Lens
v1alpha2StructuredResourceHandleVendorClaimParametersL :: Lens_' V1alpha2StructuredResourceHandle (Maybe A.Value)
v1alpha2StructuredResourceHandleVendorClaimParametersL f V1alpha2StructuredResourceHandle{..} = (\v1alpha2StructuredResourceHandleVendorClaimParameters -> V1alpha2StructuredResourceHandle { v1alpha2StructuredResourceHandleVendorClaimParameters, ..} ) <$> f v1alpha2StructuredResourceHandleVendorClaimParameters
{-# INLINE v1alpha2StructuredResourceHandleVendorClaimParametersL #-}

-- | 'v1alpha2StructuredResourceHandleVendorClassParameters' Lens
v1alpha2StructuredResourceHandleVendorClassParametersL :: Lens_' V1alpha2StructuredResourceHandle (Maybe A.Value)
v1alpha2StructuredResourceHandleVendorClassParametersL f V1alpha2StructuredResourceHandle{..} = (\v1alpha2StructuredResourceHandleVendorClassParameters -> V1alpha2StructuredResourceHandle { v1alpha2StructuredResourceHandleVendorClassParameters, ..} ) <$> f v1alpha2StructuredResourceHandleVendorClassParameters
{-# INLINE v1alpha2StructuredResourceHandleVendorClassParametersL #-}



-- * V1alpha2VendorParameters

-- | 'v1alpha2VendorParametersDriverName' Lens
v1alpha2VendorParametersDriverNameL :: Lens_' V1alpha2VendorParameters (Maybe Text)
v1alpha2VendorParametersDriverNameL f V1alpha2VendorParameters{..} = (\v1alpha2VendorParametersDriverName -> V1alpha2VendorParameters { v1alpha2VendorParametersDriverName, ..} ) <$> f v1alpha2VendorParametersDriverName
{-# INLINE v1alpha2VendorParametersDriverNameL #-}

-- | 'v1alpha2VendorParametersParameters' Lens
v1alpha2VendorParametersParametersL :: Lens_' V1alpha2VendorParameters (Maybe A.Value)
v1alpha2VendorParametersParametersL f V1alpha2VendorParameters{..} = (\v1alpha2VendorParametersParameters -> V1alpha2VendorParameters { v1alpha2VendorParametersParameters, ..} ) <$> f v1alpha2VendorParametersParameters
{-# INLINE v1alpha2VendorParametersParametersL #-}
